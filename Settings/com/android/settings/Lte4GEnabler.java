...
public class Lte4GEnabler
{
  ...
  public Lte4GEnabler(Context paramContext, Switch paramSwitch)
  {
    ...
    this.mCtMccMncs = paramContext.getResources().getStringArray(2131361912);
  }
  ...
  {
    this.mAlertDialog = new AlertDialog.Builder(this.mContext).setMessage(this.mContext.getString(2131628133)).setNeutralButton(2131625134, new DialogInterface.OnClickListener()
    {
      public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt) {}
    }).setPositiveButton(2131625133, new DialogInterface.OnClickListener()
    {
      public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
      {
        Lte4GEnabler.-wrap1(Lte4GEnabler.this);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/Lte4GEnabler.class
