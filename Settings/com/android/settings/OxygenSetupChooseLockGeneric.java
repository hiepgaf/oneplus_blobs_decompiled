  ...
  extends OxygenChooseLockGeneric
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    ((LinearLayout)findViewById(2131821272)).setFitsSystemWindows(false);
  }
    ...
    extends OxygenChooseLockGeneric.ChooseLockGenericFragment
  {
    ...
    protected void addHeaderView()
    {
      ...
      {
        setHeaderView(2130968863);
        return;
      }
      setHeaderView(2130968864);
    }
    ...
    public void onViewCreated(View paramView, Bundle paramBundle)
    {
      ...
      paramView.setIcon(getContext().getDrawable(2130837780));
      if (this.mForFingerprint) {}
      for (int i = 2131625506;; i = 2131625508)
      {
        if (getActivity() != null) {
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/OxygenSetupChooseLockGeneric.class
