...
public class AppHeader
{
  ...
  {
    ImageView localImageView = (ImageView)paramView.findViewById(2131820700);
    localImageView.setImageDrawable(paramDrawable);
    int i;
    if (paramDrawable != null)
    {
      localImageView.setVisibility(0);
      i = paramActivity.getResources().getDimensionPixelSize(2131689806);
      ...
      ((TextView)paramView.findViewById(2131820701)).setText(paramCharSequence);
    ...
    do
    {
      ...
      i = paramActivity.getResources().getDimensionPixelSize(2131689805);
      paramView.getLayoutParams().height = i;
      break;
      ...
      paramView.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          ...
          {
            AppInfoBase.startAppInfoFragment(InstalledAppDetails.class, 2131626438, paramString, paramInt1, paramActivity, 1);
            return;
          }
    ...
    paramDrawable = paramView.findViewById(2131820702);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/AppHeader.class
