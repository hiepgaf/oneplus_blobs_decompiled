  ...
  extends SettingsPreferenceFragment
{
  ...
  {
    this.mPageIndicator.setContentDescription(getPrefContext().getString(2131625190, new Object[] { Integer.valueOf(paramInt + 1), Integer.valueOf(this.mPreviewSampleResIds.length) }));
  }
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, final Bundle paramBundle)
  {
    ...
    this.mLabel = ((TextView)paramLayoutInflater.findViewById(2131820911));
    int i = Math.max(1, this.mEntries.length - 1);
    paramBundle = (LabeledSeekBar)paramLayoutInflater.findViewById(2131820913);
    ...
    this.mSmaller = paramLayoutInflater.findViewById(2131820912);
    ...
    this.mLarger = paramLayoutInflater.findViewById(2131820914);
    ...
    this.mPreviewPager = ((ViewPager)paramLayoutInflater.findViewById(2131821177));
    ...
    if (bool)
    {
      ...
      this.mPageIndicator = ((DotsPageIndicator)paramLayoutInflater.findViewById(2131820910));
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/PreviewSeekBarPreferenceFragment.class
