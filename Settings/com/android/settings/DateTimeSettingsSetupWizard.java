  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener, CompoundButton.OnCheckedChangeListener, PreferenceFragment.OnPreferenceStartFragmentCallback
{
  ...
  public void initUiForXl()
  {
    ...
    this.mTimeZoneButton = ((Button)findViewById(2131820846));
    ...
    if (((Intent)localObject).hasExtra("extra_initial_auto_datetime_value"))
    {
      ...
      this.mAutoDateTimeButton = ((CompoundButton)findViewById(2131820848));
      this.mAutoDateTimeButton.setChecked(bool1);
      this.mAutoDateTimeButton.setOnCheckedChangeListener(this);
      this.mTimePicker = ((TimePicker)findViewById(2131820853));
    ...
    for (boolean bool2 = false;; bool2 = true)
    {
      ...
      this.mDatePicker = ((DatePicker)findViewById(2131820850));
      ...
      ((Button)findViewById(2131820762)).setOnClickListener(this);
      localObject = (Button)findViewById(2131820892);
      if (localObject != null) {
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (findViewById(2131820846) != null)
    {
    ...
    for (;;)
    {
      ...
      if (!this.mUsingXLargeLayout) {
        findViewById(2131820842).setSystemUiVisibility(4194304);
      }
      return;
      bool = false;
      break;
      label83:
      findViewById(2131820762).setOnClickListener(this);
    }
  }
  ...
  public void onItemClick(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      ((DateTimeSettings)getFragmentManager().findFragmentById(2131820844)).updateTimeAndDateDisplay(this);
    }
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/DateTimeSettingsSetupWizard.class
