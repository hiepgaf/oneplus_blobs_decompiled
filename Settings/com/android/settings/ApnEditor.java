  ...
  implements Preference.OnPreferenceChangeListener, View.OnKeyListener
{
  ...
  private String bearerDescription(String paramString)
  {
    ...
    return this.mRes.getStringArray(2131361873)[i];
  }
  
  private String bearerMultiDescription(Set<String> paramSet)
  {
    String[] arrayOfString = this.mRes.getStringArray(2131361873);
  ...
  private void fillUi()
  {
    ...
    if (this.mFirstTime)
    {
      ...
      if ((!this.mNewApn) || (!getResources().getBoolean(2131492908))) {
        break label1141;
      }
    ...
    if (localObject1 != null)
    {
      ...
      this.mAuthType.setValueIndex(i);
      localObject1 = this.mRes.getStringArray(2131361869);
      ...
      if (!getResources().getBoolean(2131492914)) {
        break label1248;
      }
    ...
    for (;;)
    {
      ...
      localObject2 = getResources().getStringArray(2131361916);
      i = 0;
  ...
  private String getErrorMsg()
  {
    ...
    if (str3.length() < 1) {
      str1 = this.mRes.getString(2131626239);
    }
    do
    {
      return str1;
      if (str4.length() < 1) {
        return this.mRes.getString(2131626240);
      }
      if (str5.length() != 3) {
        return this.mRes.getString(2131626241);
      }
    } while ((str2.length() & 0xFFFE) == 2);
    return this.mRes.getString(2131626242);
  }
  ...
  private String mvnoDescription(String paramString)
  {
    ...
    String[] arrayOfString = this.mRes.getStringArray(2131361875);
  ...
  private String protocolDescription(String paramString, ListPreference paramListPreference)
  {
    ...
    return this.mRes.getStringArray(2131361871)[i];
  }
  ...
  private boolean validateAndSave(boolean paramBoolean)
  {
    ...
    if (str1.length() < 1) {
      localObject = getResources().getString(2131627019);
    }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    sNotSet = getResources().getString(2131626196);
  ...
  public void onCreateOptionsMenu(Menu paramMenu, MenuInflater paramMenuInflater)
  {
    ...
    if (!this.mNewApn) {
      paramMenu.add(0, 1, 0, 2131626234).setIcon(2130837790);
    }
    paramMenu.add(0, 2, 0, 2131626236).setIcon(17301582);
    paramMenu.add(0, 3, 0, 2131626237).setIcon(17301560);
  }
  ...
  public boolean onPreferenceChange(Preference paramPreference, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.mAuthType.setValueIndex(i);
        paramPreference = this.mRes.getStringArray(2131361869);
    ...
    extends DialogFragment
  {
    ...
    public Dialog onCreateDialog(Bundle paramBundle)
    {
      ...
      return new AlertDialog.Builder(getContext()).setTitle(2131626238).setPositiveButton(17039370, null).setMessage(paramBundle).create();
    }
  }
}


/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/ApnEditor.class
