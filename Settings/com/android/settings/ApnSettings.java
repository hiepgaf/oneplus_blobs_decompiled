  ...
  implements Preference.OnPreferenceChangeListener
{
  ...
  private void fillList()
  {
    ...
    if (this.mSubscriptionInfo == null)
    {
      ...
      if (SystemProperties.getBoolean("persist.sys.hideapn", true))
      {
        ...
        if (getResources().getBoolean(2131492903)) {
          this.mHideImsApn = true;
        }
        if (getResources().getBoolean(2131492904))
        {
          localObject3 = getResources().getStringArray(2131361913);
          i = 0;
        ...
        if (getResources().getBoolean(2131492905))
        {
          m = 0;
          localObject3 = getResources().getStringArray(2131361914);
          i = 0;
        ...
        if (getResources().getBoolean(2131492906)) {
          ((StringBuilder)localObject2).append(" and type <>\"mms\"");
        }
      }
      if (getResources().getBoolean(2131492913))
      {
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    getEmptyTextView().setText(2131624097);
  ...
  public Dialog onCreateDialog(int paramInt)
  {
    if (paramInt == 1001)
    {
      ...
      local2.setMessage(getResources().getString(2131626243));
  ...
  public void onCreateOptionsMenu(Menu paramMenu, MenuInflater paramMenuInflater)
  {
    if (!this.mUnavailable)
    {
      if (this.mAllowAddingApns) {
        paramMenu.add(0, 1, 0, getResources().getString(2131626235)).setIcon(17301555).setShowAsAction(1);
      }
      paramMenu.add(0, 2, 0, getResources().getString(2131626244)).setIcon(17301589);
    }
    ...
    extends Handler
  {
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      Toast.makeText(paramMessage, ApnSettings.this.getResources().getString(2131626245), 1).show();
    }
  }
}


/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/ApnSettings.class
