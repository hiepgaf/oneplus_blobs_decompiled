  ...
  implements Preference.OnPreferenceChangeListener, OPFactoryResetConfirmCategory.OnFactoryResetConfirmListener
{
  ...
  {
    View localView = this.mContentView.findViewById(2131820950);
    LinearLayout localLinearLayout = (LinearLayout)this.mContentView.findViewById(2131820951);
    ...
    Object localObject3 = this.mContentView.findViewById(2131820952);
  ...
  private boolean runKeyguardConfirmation(int paramInt)
  {
    ...
    return new ChooseLockSettingsHelper(getActivity(), this).launchConfirmationActivity(paramInt, localResources.getText(2131626255));
  }
  ...
  private void showFinalConfirmation(String paramString)
  {
    ...
    ((SettingsActivity)getActivity()).startPreferencePanel(MasterClearConfirm.class.getName(), localBundle, 2131626267, null, null, 0);
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/MasterClear.class
