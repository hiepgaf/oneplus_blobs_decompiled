  ...
  extends OptionsMenuFragment
{
  ...
  private View.OnClickListener mFinalClickListener = new View.OnClickListener()
  {
    private ProgressDialog getProgressDialog()
    {
      ...
      localProgressDialog.setTitle(MasterClearConfirm.this.getActivity().getString(2131626269));
      localProgressDialog.setMessage(MasterClearConfirm.this.getActivity().getString(2131626270));
  ...
  {
    this.mContentView.findViewById(2131820958).setOnClickListener(this.mFinalClickListener);
  }
  
  private void setAccessibilityTitle()
  {
    CharSequence localCharSequence = getActivity().getTitle();
    Object localObject = (TextView)this.mContentView.findViewById(2131820957);
    if (localObject != null)
    {
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/MasterClearConfirm.class
