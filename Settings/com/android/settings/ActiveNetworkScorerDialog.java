  ...
  implements DialogInterface.OnClickListener
{
  ...
  private boolean buildDialog()
  {
    ...
    localAlertParams.mTitle = getString(2131626298);
    if (localNetworkScorerAppData != null) {}
    for (localAlertParams.mMessage = getString(2131626299, new Object[] { localObject, localNetworkScorerAppData.mScorerName });; localAlertParams.mMessage = getString(2131626300, new Object[] { localObject }))
    {
      localAlertParams.mPositiveButtonText = getString(2131625133);
      localAlertParams.mNegativeButtonText = getString(2131625134);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/ActiveNetworkScorerDialog.class
