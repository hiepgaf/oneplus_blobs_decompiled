  ...
  extends ProgressCategoryBase
{
  ...
  public ProgressCategory(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    setLayoutResource(2130968902);
  }
  
  public void onBindViewHolder(PreferenceViewHolder paramPreferenceViewHolder)
  {
    super.onBindViewHolder(paramPreferenceViewHolder);
    paramPreferenceViewHolder = paramPreferenceViewHolder.findViewById(2131821166);
    int i;
    int j;
    if (getPreferenceCount() != 0)
    {
      ...
      if (!this.mNoDeviceFoundAdded)
      {
        if (this.mNoDeviceFoundPreference == null)
        {
          ...
          this.mNoDeviceFoundPreference.setLayoutResource(2130968885);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/ProgressCategory.class
