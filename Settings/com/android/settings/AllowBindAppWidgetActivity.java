  ...
  implements DialogInterface.OnClickListener
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      ((AlertController.AlertParams)localObject).mTitle = getString(2131626666);
      ((AlertController.AlertParams)localObject).mMessage = getString(2131626667, new Object[] { paramBundle });
      ((AlertController.AlertParams)localObject).mPositiveButtonText = getString(2131625135);
      ...
      this.mAlwaysUse.setText(getString(2131626668, new Object[] { paramBundle }));
      this.mAlwaysUse.setPadding(this.mAlwaysUse.getPaddingLeft(), this.mAlwaysUse.getPaddingTop(), this.mAlwaysUse.getPaddingRight(), (int)(this.mAlwaysUse.getPaddingBottom() + getResources().getDimension(2131689933)));
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/AllowBindAppWidgetActivity.class
