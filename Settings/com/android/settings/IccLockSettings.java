  ...
  implements EditPinPreference.OnPinEnteredListener
{
      ...
      if ("android.intent.action.ACTION_SUBINFO_CONTENT_CHANGE".equals(paramAnonymousContext))
      {
        ...
        if (j > 1)
        {
          ...
          if (i < j)
          {
            ...
            for (paramAnonymousContext = IccLockSettings.this.getContext().getString(2131627455, new Object[] { Integer.valueOf(i + 1) });; paramAnonymousContext = paramAnonymousContext.getDisplayName())
            {
  ...
  private String getPinPasswordErrorMessage(int paramInt)
  {
    String str;
    if (paramInt == 0) {
      str = this.mRes.getString(2131626034);
    }
    for (;;)
    {
      ...
      if (paramInt > 0) {
        ...
        str = this.mRes.getString(2131626035);
      }
    }
  }
  ...
  static String getSummary(Context paramContext)
  {
    ...
    if (isIccLockEnabled()) {
      return paramContext.getString(2131626011);
    }
    return paramContext.getString(2131626012);
  }
  ...
  private void iccPinChanged(boolean paramBoolean, int paramInt)
  {
    ...
    for (;;)
    {
      resetDialogState();
      return;
      Toast.makeText(getContext(), this.mRes.getString(2131626024), 0).show();
    }
  }
  ...
  private void setDialogValues()
  {
    ...
    for (;;)
    {
      ...
      return;
      localObject2 = this.mRes.getString(2131626014);
      EditPinPreference localEditPinPreference = this.mPinDialog;
      if (this.mToState) {}
      for (localObject1 = this.mRes.getString(2131626015);; localObject1 = this.mRes.getString(2131626016))
      {
        localEditPinPreference.setDialogTitle((CharSequence)localObject1);
        localObject1 = localObject2;
        break;
      }
      localObject1 = this.mRes.getString(2131626017);
      this.mPinDialog.setDialogTitle(this.mRes.getString(2131626020));
      continue;
      localObject1 = this.mRes.getString(2131626018);
      this.mPinDialog.setDialogTitle(this.mRes.getString(2131626020));
      continue;
      localObject1 = this.mRes.getString(2131626019);
      this.mPinDialog.setDialogTitle(this.mRes.getString(2131626020));
    }
  }
  ...
  {
    if ((this.mPhone != null) && (this.mPinToggle != null) && (this.mPinDialog != null)) {
    ...
    while ((this.mPinToggle == null) || (this.mPinDialog == null)) {
      for (;;)
      {
        return;
        this.mPinToggle.setEnabled(true);
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    if (j > 1)
    {
      ...
      ViewGroup localViewGroup = (ViewGroup)localView.findViewById(2131820684);
      ...
      if (i < j)
      {
        ...
        for (paramLayoutInflater = getContext().getString(2131627455, new Object[] { Integer.valueOf(i + 1) });; paramLayoutInflater = paramLayoutInflater.getDisplayName())
        {
  ...
  public void onPinEntered(EditPinPreference paramEditPinPreference, boolean paramBoolean)
  {
    ...
    {
      this.mError = this.mRes.getString(2131626021);
      showPinDialog();
      return;
    }
    switch (this.mDialogState)
    ...
    {
      this.mError = this.mRes.getString(2131626022);
      this.mDialogState = 3;
      this.mPin = null;
      showPinDialog();
      return;
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/IccLockSettings.class
