    ...
    extends ListPreferenceDialogFragment
  {
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder paramBuilder)
    {
      ...
      if (!getCustomizablePreference().isAutoClosePreference()) {
        paramBuilder.setPositiveButton(2131625356, new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
            CustomListPreference.CustomListPreferenceDialogFragment.this.onClick(paramAnonymousDialogInterface, -1);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/CustomListPreference.class
