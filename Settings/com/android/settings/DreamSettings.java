  ...
  implements SwitchBar.OnSwitchChangeListener
{
  ...
  {
    String str1 = this.mContext.getString(2131625996);
    String str2 = this.mContext.getString(2131625995);
    String str3 = this.mContext.getString(2131625994);
    int i;
    ...
    for (;;)
    {
      AlertDialog.Builder localBuilder = new AlertDialog.Builder(this.mContext).setTitle(2131625999);
  ...
  public static CharSequence getSummaryTextWithDreamName(Context paramContext)
  {
    ...
    if (!localDreamBackend.isEnabled()) {
      return paramContext.getString(2131625997);
    }
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    paramBundle.setText(2131625998);
  ...
  public void onCreateOptionsMenu(Menu paramMenu, MenuInflater paramMenuInflater)
  {
    ...
    boolean bool = this.mBackend.isEnabled();
    MenuItem localMenuItem1 = createMenuItem(paramMenu, 2131626000, 0, bool, new Runnable()
    {
      public void run()
      {
    ...
    MenuItem localMenuItem2 = createMenuItem(paramMenu, 2131625999, 0, bool, new Runnable()
    {
      public void run()
      {
    ...
    extends Preference
  {
    ...
    public void onBindViewHolder(final PreferenceViewHolder paramPreferenceViewHolder)
    {
      ...
      {
        i = 1;
        localObject = paramPreferenceViewHolder.findViewById(2131820778);
        if (i == 0) {
          break label158;
        }
        j = 0;
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/DreamSettings.class
