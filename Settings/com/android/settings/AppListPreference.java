  ...
  extends CustomListPreference
{
  ...
  public void setComponentNames(ComponentName[] paramArrayOfComponentName, ComponentName paramComponentName, CharSequence[] paramArrayOfCharSequence)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        if (this.mShowItemNone)
        {
          localArrayList1.add(getContext().getResources().getText(2131627890));
          localArrayList2.add("");
          localArrayList3.add(getContext().getDrawable(2130837811));
        }
    ...
    extends ArrayAdapter<CharSequence>
  {
    ...
    public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
    {
      ...
      {
        paramView.findViewById(2131820715).setVisibility(0);
      ...
      for (boolean bool1 = bool2;; bool1 = false)
      {
        ...
        {
          paramView.findViewById(2131820713).setVisibility(0);
          break;
        }
        if (paramInt != AppListPreference.-get1(AppListPreference.this)) {
          break;
        }
        paramView.findViewById(2131820714).setVisibility(0);
        break;
      }
    }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/AppListPreference.class
