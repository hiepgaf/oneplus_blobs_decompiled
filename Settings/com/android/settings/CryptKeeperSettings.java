  ...
  extends InstrumentedFragment
{
  ...
  private View.OnClickListener mInitiateListener = new View.OnClickListener()
  {
    public void onClick(View paramAnonymousView)
    {
      if (!CryptKeeperSettings.-wrap0(CryptKeeperSettings.this, 55)) {
        new AlertDialog.Builder(CryptKeeperSettings.this.getActivity()).setTitle(2131625487).setMessage(2131625488).setPositiveButton(17039370, null).create().show();
      }
    }
  };
  ...
  private boolean runKeyguardConfirmation(int paramInt)
  {
    ...
    return localChooseLockSettingsHelper.launchConfirmationActivity(paramInt, localResources.getText(2131625481), true);
  }
  ...
  private void showFinalConfirmation(int paramInt, String paramString)
  {
    ...
    localPreference.setTitle(2131625489);
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.mInitiateButton = ((Button)this.mContentView.findViewById(2131820813));
    this.mInitiateButton.setOnClickListener(this.mInitiateListener);
    this.mInitiateButton.setEnabled(false);
    this.mPowerWarning = this.mContentView.findViewById(2131820812);
    this.mBatteryWarning = this.mContentView.findViewById(2131820811);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/CryptKeeperSettings.class
