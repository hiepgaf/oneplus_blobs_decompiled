  ...
  extends ConfirmDeviceCredentialBaseActivity
{
    ...
    implements View.OnClickListener, TextView.OnEditorActionListener, CredentialCheckResultTracker.Listener
  {
    ...
    private void handleAttemptLockout(long paramLong)
    {
      ...
      this.mCountdownTimer = new CountDownTimer(paramLong - l, 1000L)
      {
        ...
        public void onTick(long paramAnonymousLong)
        {
          ...
          OxygenConfirmLockPassword.ConfirmLockPasswordFragment.this.showError(OxygenConfirmLockPassword.ConfirmLockPasswordFragment.this.getString(2131626414, new Object[] { Integer.valueOf(i) }), 0L);
        }
      }.start();
    }
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
    {
      ...
      View localView = paramLayoutInflater.inflate(2130969138, null);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/OxygenConfirmLockPassword.class
