  ...
  implements FingerprintUiHelper.Callback
{
  ...
  {
    Object localObject = getActivity().findViewById(2131821268);
    if (localObject != null) {
    ...
    paramView = (ImageView)paramView.findViewById(2131820783);
    if (paramView != null)
    {
      localObject = getResources().getDrawable(2130838297);
      ((Drawable)localObject).setColorFilter(getResources().getColor(2131428149), PorterDuff.Mode.DARKEN);
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    this.mCancelButton = ((Button)paramView.findViewById(2131820785));
    this.mFingerprintIcon = ((ImageView)paramView.findViewById(2131820786));
    this.mFingerprintHelper = new FingerprintUiHelper(this.mFingerprintIcon, (TextView)paramView.findViewById(2131820787), this, this.mEffectiveUserId);
  ...
  protected void updateErrorMessage(int paramInt)
  {
    ...
    if ((i > 0) && (paramInt > 0))
    {
      ...
      showDialog(getActivity().getString(2131625565), getActivity().getString(getLastTryErrorMessage()), 17039370, false);
    }
    for (;;)
    {
      if (this.mErrorTextView != null) {
        showError(getActivity().getString(2131625564, new Object[] { Integer.valueOf(paramInt), Integer.valueOf(i) }), 0L);
      }
      return;
      label99:
      if (j <= 0) {
        showDialog(null, getActivity().getString(2131625569), 2131625570, true);
      }
    }
  }
}
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/OxygenConfirmDeviceCredentialBaseFragment.class
