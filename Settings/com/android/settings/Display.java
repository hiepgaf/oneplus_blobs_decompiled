  ...
  implements View.OnClickListener
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.mFontSize = ((Spinner)findViewById(2131820874));
    this.mFontSize.setOnItemSelectedListener(this.mFontSizeChanged);
    paramBundle = getResources();
    Object localObject = new ArrayAdapter(this, 17367048, new String[] { paramBundle.getString(2131625192), paramBundle.getString(2131625193), paramBundle.getString(2131625194) });
    ((ArrayAdapter)localObject).setDropDownViewResource(17367049);
    this.mFontSize.setAdapter((SpinnerAdapter)localObject);
    this.mPreview = ((TextView)findViewById(2131820875));
    this.mPreview.setText(paramBundle.getText(2131625197));
    localObject = (Button)findViewById(2131820876);
    ((Button)localObject).setText(paramBundle.getText(2131625202));
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/Display.class
