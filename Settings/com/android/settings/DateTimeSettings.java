  ...
  implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener, Preference.OnPreferenceChangeListener, Indexable
{
  ...
  public Dialog onCreateDialog(int paramInt)
  {
    ...
    case 0: 
      localObject = new DatePickerDialog(getActivity(), this, ((Calendar)localObject).get(1), ((Calendar)localObject).get(2), ((Calendar)localObject).get(5));
  ...
  public void onDateSet(final DatePicker paramDatePicker, final int paramInt1, final int paramInt2, final int paramInt3)
  {
    ...
    if (paramDatePicker != null) {
      this.mHandler.postDelayed(new Runnable()
      {
        public void run()
        {
          DateTimeSettings.setDate(paramDatePicker, paramInt1, paramInt2, paramInt3);
          DateTimeSettings.this.updateTimeAndDateDisplay(paramDatePicker);
        }
      }, 500L);
    }
  }
  ...
  public void onTimeSet(final TimePicker paramTimePicker, final int paramInt1, final int paramInt2)
  {
    ...
    if (paramTimePicker != null) {
      this.mHandler.postDelayed(new Runnable()
      {
        public void run()
        {
          DateTimeSettings.setTime(paramTimePicker, paramInt1, paramInt2);
          DateTimeSettings.this.updateTimeAndDateDisplay(paramTimePicker);
        }
      }, 500L);
    }
  }
  ...
  public void updateTimeAndDateDisplay(Context paramContext)
  {
    ...
    if (getResources().getBoolean(2131492944))
    {
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/DateTimeSettings.class
