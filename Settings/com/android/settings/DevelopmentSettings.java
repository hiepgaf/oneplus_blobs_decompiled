  ...
  implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener, Preference.OnPreferenceChangeListener, SwitchBar.OnSwitchChangeListener, Indexable
{
  ...
  public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider()
  {
    ...
    public List<String> getNonIndexableKeys(Context paramAnonymousContext)
    {
      ...
      if (!paramAnonymousContext.getResources().getBoolean(2131492917)) {
  ...
  private void confirmEnableOemUnlock()
  {
    ...
    new AlertDialog.Builder(getActivity()).setTitle(2131624109).setMessage(2131624110).setPositiveButton(2131626459, local3).setNegativeButton(17039360, null).setOnDismissListener(local4).create().show();
  }
  ...
  private void resetShortcutManagerThrottling()
  {
    ...
    try
    {
      ...
      Toast.makeText(getActivity(), 2131628067, 0).show();
      return;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  {
    return new ChooseLockSettingsHelper(getActivity(), this).launchConfirmationActivity(paramInt, paramResources.getString(2131624107));
  }
  ...
  {
    ((SettingsActivity)getActivity()).startPreferencePanel(BackgroundCheckSummary.class.getName(), null, 2131627855, null, null, 0);
  }
  
  private void startInactiveAppsFragment()
  {
    ((SettingsActivity)getActivity()).startPreferencePanel(InactiveApps.class.getName(), null, 2131624213, null, null, 0);
  }
  ...
  private void updateDebuggerOptions()
  {
    ...
    else
    {
      for (;;)
      {
        ...
        this.mDebugAppPref.setSummary(getResources().getString(2131624152, new Object[] { localObject }));
    ...
    this.mDebugAppPref.setSummary(getResources().getString(2131624151));
  ...
  private void updateHdcpValues()
  {
    ...
    if (localListPreference != null)
    {
      ...
      arrayOfString1 = getResources().getStringArray(2131361795);
      arrayOfString2 = getResources().getStringArray(2131361796);
      k = 1;
      i = 0;
    }
    for (;;)
  ...
  private void updateLogdSizeValues()
  {
    ...
    if (this.mLogdSize != null)
    {
      ...
      localObject3 = getResources().getStringArray(2131361799);
      localObject1 = getResources().getStringArray(2131361797);
      i = 2;
      if (SystemProperties.get("ro.config.low_ram").equals("true"))
      {
        this.mLogdSize.setEntries(2131361798);
        localObject1 = getResources().getStringArray(2131361798);
        i = 1;
      }
      arrayOfString = getResources().getStringArray(2131361800);
      j = 0;
    }
    for (;;)
    {
  ...
  private void updateLogpersistValues()
  {
    ...
    {
      this.mLogpersist.setValue(getResources().getStringArray(2131361801)[i]);
      this.mLogpersist.setSummary(getResources().getStringArray(2131361803)[i]);
  ...
  private void updateMockLocation()
  {
    ...
    this.mMockLocationAppPref.setSummary(getString(2131624113, new Object[] { localObject1 }));
    this.mHaveDebugSettings = true;
    return;
    this.mMockLocationAppPref.setSummary(getString(2131624112));
  }
  ...
  private void updatePasswordSummary()
  {
    try
    {
      ...
      {
        this.mPassword.setSummary(2131624209);
        return;
      }
      this.mPassword.setSummary(2131624208);
      return;
    }
    catch (RemoteException localRemoteException) {}
  }
  ...
  private void updateSimulateColorSpace()
  {
    ...
    while (i != 0)
    {
      ...
      {
        this.mSimulateColorSpace.setSummary(getString(2131624238, new Object[] { getString(2131624236) }));
        return;
        i = 0;
      }
      else
  ...
  private void updateUsbConfigurationValues()
  {
    ...
    if (this.mUsbConfiguration != null)
    {
      ...
      arrayOfString1 = getResources().getStringArray(2131361823);
      arrayOfString2 = getResources().getStringArray(2131361822);
      k = 0;
      i = 0;
    }
    for (;;)
  ...
  private void writeColorTemperature()
  {
    ...
    for (String str = "1";; str = "0")
    {
      ...
      pokeSystemProperties();
      Toast.makeText(getActivity(), 2131627985, 1).show();
      return;
    }
  }
  ...
  private void writeLogpersistOption(Object paramObject, boolean paramBoolean)
  {
    ...
    if ((localObject == null) || (localObject.toString().equals("")))
    {
      ...
      this.mLogpersistClearDialog = new AlertDialog.Builder(getActivity()).setMessage(getActivity().getResources().getString(2131624128)).setTitle(2131624127).setPositiveButton(17039379, this).setNegativeButton(17039369, this).show();
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      if ("1".equals(SystemProperties.get("ro.debuggable", "0")))
      {
        ...
        localObject = findPreference("hdcp_checking");
        if (localObject != null)
        {
      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if ((!SettingsBaseApplication.mApplication.getPackageManager().hasSystemFeature("oem.service.adb.tcp.port.support")) && (paramBundle != null)) {
          ...
          if ("file".equals(SystemProperties.get("ro.crypto.type", "none")))
          {
            ...
            ((PreferenceScreen)localObject).setSummary(getResources().getString(2131624225));
          }
        }
      }
      catch (RemoteException localRemoteException)
  ...
  public boolean onPreferenceChange(Preference paramPreference, Object paramObject)
  {
    ...
    if (paramPreference == this.mWebViewProvider)
    {
      ...
      Toast.makeText(getActivity(), 2131624222, 0).show();
      return false;
    }
    ...
    try
    {
      ...
      if (paramPreference == this.mEnableAdb) {
        if (this.mEnableAdb.isChecked())
        {
          ...
          this.mAdbDialog = new AlertDialog.Builder(getActivity()).setMessage(getActivity().getResources().getString(2131624138)).setTitle(2131624137).setPositiveButton(17039379, this).setNegativeButton(17039369, this).show();
      ...
      do
      {
        ...
        if (paramPreference == this.mClearAdbKeys)
        {
          ...
          this.mAdbKeysDialog = new AlertDialog.Builder(getActivity()).setMessage(2131624139).setPositiveButton(17039370, this).setNegativeButton(17039360, null).show();
          return false;
        }
  ...
  public void onResume()
  {
    ...
    if (this.mUnavailable)
    {
      if (!isUiRestrictedByOnlyAdmin()) {
        getEmptyTextView().setText(2131624094);
      }
  ...
  {
    if (paramSwitch != this.mSwitchBar.getSwitch()) {
      return;
    }
    if (paramBoolean != this.mLastEnabledState)
    {
      if (paramBoolean)
      {
        ...
        this.mEnableDialog = new AlertDialog.Builder(getActivity()).setMessage(getActivity().getResources().getString(2131624141)).setTitle(2131624140).setPositiveButton(17039379, this).setNegativeButton(17039369, this).show();
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/DevelopmentSettings.class
