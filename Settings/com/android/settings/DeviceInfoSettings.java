  ...
  implements Indexable
{
  ...
  public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider()
  {
    ...
    public List<String> getNonIndexableKeys(Context paramAnonymousContext)
    {
      ...
      if (!paramAnonymousContext.getResources().getBoolean(2131492879)) {
      ...
      if (paramAnonymousContext.getPackageManager().hasSystemFeature("oem.authentication_information.support"))
      {
        ...
        if ((!paramAnonymousContext.getPackageManager().queryIntentActivities(localIntent, 0).isEmpty()) && (paramAnonymousContext.getResources().getBoolean(2131492883)) && (!str2.contains("A3003"))) {
          break label299;
        }
        label267:
  ...
  private void setStringSummary(String paramString1, String paramString2)
  {
    ...
    {
      findPreference(paramString1).setSummary(getResources().getString(2131625148));
    }
  }
  ...
  private void setValueSummary(String paramString1, String paramString2)
  {
    try
    {
      findPreference(paramString1).setSummary(SystemProperties.get(paramString2, getResources().getString(2131625148)));
      return;
    }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    if (!TextUtils.isEmpty(paramBundle))
    {
      ...
      findPreference("kernel_version").setSummary(DeviceInfoUtils.customizeFormatKernelVersion(getResources().getBoolean(2131492945)));
      ...
      setStringSummary("selinux_status", getResources().getString(2131627266));
      ...
      if ((!Build.MODEL.equalsIgnoreCase("ONEPLUS A5000")) && (!getActivity().getPackageManager().hasSystemFeature("oem.authentication_information.support")))
      {
      ...
      if (getResources().getBoolean(2131492900)) {
        removePreference("system_update_settings");
      }
      removePreferenceIfBoolFalse("additional_system_update_settings", 2131492879);
      removePreferenceIfBoolFalse("manual", 2131492881);
      ...
      if ((!Build.MODEL.equalsIgnoreCase("ONEPLUS A5000")) && ((getPackageManager().queryIntentActivities((Intent)localObject1, 0).isEmpty()) || (!getResources().getBoolean(2131492883)) || (((String)localObject2).contains("A3003")) || (!paramBundle.contains("Am")))) {
        break label871;
      }
      label611:
      ...
      findPreference("oneplus_oos_version").setTitle(getActivity().getResources().getString(2131625098));
      findPreference("oneplus_oos_version").setSummary(SystemProperties.get("ro.oxygen.version", getResources().getString(2131625148)));
    }
    for (;;)
    {
      if (OPUtils.isO2()) {
        getPreferenceScreen().removePreference(findPreference("oneplus_pre_application"));
      }
      ...
      setStringSummary("selinux_status", getResources().getString(2131627267));
      break label347;
      label871:
      localObject1 = findPreference("regulatory_info");
      if (localObject1 == null) {
      ...
      break label691;
      label946:
      findPreference("oneplus_oos_version").setTitle(getActivity().getResources().getString(2131624626).replace("H2", "H₂"));
      findPreference("oneplus_oos_version").setSummary(SystemProperties.get("ro.rom.version", getResources().getString(2131625148)).replace("H2", "H₂"));
    }
  }
        ...
        if (paramPreference.getKey().equals("build_number"))
        {
          ...
          if (this.mDevHitCountdown > 0)
          {
            ...
            if (this.mDevHitCountdown == 0)
            {
              ...
              this.mDevHitToast = Toast.makeText(getActivity(), 2131625149, 1);
          ...
          else if (this.mDevHitCountdown < 0)
          {
            ...
            this.mDevHitToast = Toast.makeText(getActivity(), 2131625150, 1);
            this.mDevHitToast.show();
          }
        }
    ...
    implements SummaryLoader.SummaryProvider
  {
    ...
    {
      if (paramBoolean) {
        this.mSummaryLoader.setSummary(this, this.mContext.getString(2131627956, new Object[] { Build.VERSION.RELEASE }));
      }
    }
  }
}
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/DeviceInfoSettings.class
