  ...
  extends Activity
{
  ...
  {
    Toast.makeText(this, 2131626354, 1).show();
    finish();
  }
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    if (!getResources().getBoolean(2131492881)) {
      finish();
    }
    ...
    ((Intent)localObject).putExtra("android.intent.extra.TITLE", getString(2131626353));
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/ManualDisplayActivity.class
