    ...
    extends SettingsPreferenceFragment
  {
    ...
    private void updateCurrentPreference()
    {
      ...
      if (localPreference != null) {
        localPreference.setSummary(2131625528);
      }
    }
    ...
    private void updatePreferenceSummaryIfNeeded()
    {
      ...
      String str1 = getString(2131626752);
    ...
    private void updatePreferenceText()
    {
      ...
      if (this.mForFingerprint)
      {
        ...
        while (i < arrayOfString.length)
        {
          ...
          if (localPreference != null) {
            localPreference.setTitle(new int[] { 2131625529, 2131625530, 2131625531 }[i]);
          }
          i += 1;
        }
      }
    ...
    protected void addHeaderView()
    {
      if (this.mForFingerprint)
      {
        setHeaderView(2130968857);
        if (this.mIsSetNewPassword) {
          ((TextView)getHeaderView().findViewById(2131821114)).setText(2131625533);
        }
      }
    }
    ...
    protected void addPreferences()
    {
      ...
      findPreference("unlock_set_none").setViewId(2131820561);
      findPreference("unlock_skip_fingerprint").setViewId(2131820561);
      findPreference("unlock_set_pin").setViewId(2131820562);
      findPreference("unlock_set_password").setViewId(2131820563);
    }
    ...
    protected void disableUnusablePreferencesImpl(int paramInt, boolean paramBoolean)
    {
      ...
      if (j >= 0)
      {
        ...
        if ((localPreference instanceof RestrictedPreference))
        {
          ...
          bool = true;
          label102:
          if (getResources().getBoolean(2131492886))
          {
            bool = false;
            m = 0;
          }
        ...
        for (;;)
        {
          ...
          else if (!bool)
          {
            ...
            localPreference.setSummary(2131625534);
    ...
    public void onCreate(Bundle paramBundle)
    {
      ...
      if (!"android.app.action.SET_NEW_PARENT_PROFILE_PASSWORD".equals(str))
      {
        ...
        if (("android.app.action.SET_NEW_PASSWORD".equals(str)) && (Utils.isManagedProfile(UserManager.get(getActivity()), this.mUserId)) && (this.mLockPatternUtils.isSeparateProfileChallengeEnabled(this.mUserId))) {
          getActivity().setTitle(2131625507);
        }
      ...
      for (;;)
      {
        ...
        if (!this.mWaitingForConfirmation)
        {
          ...
          for (;;)
          {
            if ((i != 0) || (!paramBundle.launchConfirmationActivity(100, getString(2131625512), true, this.mUserId))) {
              break label633;
            }
    ...
    public boolean onPreferenceTreeClick(Preference paramPreference)
    {
      ...
      {
        paramPreference = new Intent(getActivity(), OxygenChooseLockGeneric.class);
        paramPreference.setAction(getIntent().getAction());
        paramPreference.putExtra("password_confirmed", this.mPasswordConfirmed);
      ...
      extends DialogFragment
    {
      ...
      {
        paramBundle = getArguments();
        new AlertDialog.Builder(getActivity()).setTitle(paramBundle.getInt("titleRes")).setMessage(paramBundle.getInt("messageRes")).setPositiveButton(2131625560, new DialogInterface.OnClickListener()
        {
        ...
        }).setNegativeButton(2131625355, new DialogInterface.OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/OxygenChooseLockGeneric.class
