...
{
  private static final int[] DETAIL_TEXTS = { 2131626375, 2131626376, 2131626378, 2131626379, 2131626381, 2131626382, 2131626384, 2131626385 };
  ...
  public void onWindowFocusChanged(boolean paramBoolean)
  {
    ...
    Fragment localFragment = getFragmentManager().findFragmentById(2131821268);
    ...
    implements View.OnClickListener, TextView.OnEditorActionListener, CredentialCheckResultTracker.Listener
  {
    ...
    private void handleAttemptLockout(long paramLong)
    {
      ...
      this.mHeaderTextView.setText(getString(2131624644, new Object[] { Integer.valueOf(0) }));
      ...
      this.mCountdownTimer = new CountDownTimer(paramLong - l, 1000L)
      {
        ...
        public void onTick(long paramAnonymousLong)
        {
          ...
          ConfirmLockComplexPassword.ConfirmLockPasswordFragment.-get2(ConfirmLockComplexPassword.ConfirmLockPasswordFragment.this).setText(ConfirmLockComplexPassword.ConfirmLockPasswordFragment.this.getString(2131626414, new Object[] { Integer.valueOf(i) }));
        }
      }.start();
    }
    ...
    private void handleNext()
    {
      ...
      if (str.length() < 4)
      {
        this.mHeaderTextView.setText(getString(2131625572, new Object[] { Integer.valueOf(4) }));
        return;
      }
    ...
    private void onPasswordChecked(boolean paramBoolean1, Intent paramIntent, int paramInt1, int paramInt2, boolean paramBoolean2)
    {
      ...
      paramIntent = String.format(getResources().getString(2131625123), new Object[] { getResources().getString(2131626387), getResources().getString(2131624645) });
    ...
    private void startDisappearAnimation(final Intent paramIntent)
    {
      ...
      if (getActivity().getThemeResId() == 2131756049)
      {
    ...
    public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
    {
      ...
      paramBundle = paramLayoutInflater.inflate(2130968788, null);
      this.mPasswordTextViewForPin = ((OPPasswordTextViewForPin)paramBundle.findViewById(2131821020));
      this.mPasswordTextViewForPin.setCallBack(this.mPasswordInputCountCallBack);
      this.mDeleteButton = ((TextView)paramBundle.findViewById(2131821034));
      this.mDeleteButton.setOnClickListener(this);
      this.mDeleteButton.setVisibility(0);
      this.mConfirmButton = ((TextView)paramBundle.findViewById(2131821036));
      ...
      this.mPasswordTextViewForPin.setTextEmptyListener(new OPPasswordTextViewForPin.OnTextEmptyListerner()
      {
        public void onTextChanged(String paramAnonymousString)
        {
          ...
          {
            ConfirmLockComplexPassword.ConfirmLockPasswordFragment.-get1(ConfirmLockComplexPassword.ConfirmLockPasswordFragment.this).setText(2131624959);
          ...
          for (int i = 1;; i = 0)
          {
            ...
            return;
            ConfirmLockComplexPassword.ConfirmLockPasswordFragment.-get1(ConfirmLockComplexPassword.ConfirmLockPasswordFragment.this).setText(2131624958);
            break;
          }
        }
      });
      this.mHeaderTextView = ((TextView)paramBundle.findViewById(2131820759));
      boolean bool;
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/ConfirmLockComplexPassword.class
