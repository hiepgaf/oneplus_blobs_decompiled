        ...
        if ((!AppPicker.-get0(AppPicker.this)) || ((localApplicationInfo.flags & 0x2) != 0) || (!"user".equals(Build.TYPE)))
        {
          ...
          try
          {
            ...
            if (((PackageInfo)localObject).requestedPermissions != null)
            {
              ...
              AppPicker.this.label = paramContext.getText(2131624154);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/AppPicker.class
