  ...
  implements DialogCreatable
{
  ...
  public Dialog onCreateDialog(int paramInt)
  {
    if (paramInt == 0)
    {
      ...
      return new AlertDialog.Builder(getActivity()).setTitle(2131625277).setPositiveButton(2131625278, null).setMessage(str1).create();
    }
    return null;
  }
  ...
  {
    this.mView = paramLayoutInflater.inflate(2130968923, paramViewGroup, false);
    initView(this.mView);
    populateFields();
    return this.mView;
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/ProxySelector.class
