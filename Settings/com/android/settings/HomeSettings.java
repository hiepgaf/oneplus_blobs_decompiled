  ...
  implements Indexable
{
  ...
  public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER = new BaseSearchIndexProvider()
  {
    public List<SearchIndexableRaw> getRawDataToIndex(Context paramAnonymousContext, boolean paramAnonymousBoolean)
    {
      ...
      if ((localArrayList2.size() > 1) || (paramAnonymousBoolean))
      {
        ...
        ((SearchIndexableRaw)localObject).title = localResources.getString(2131625908);
        ((SearchIndexableRaw)localObject).screenTitle = localResources.getString(2131625908);
        ((SearchIndexableRaw)localObject).keywords = localResources.getString(2131627487);
    ...
    extends Preference
  {
    ...
    public void onBindViewHolder(PreferenceViewHolder paramPreferenceViewHolder)
    {
      ...
      ((RadioButton)paramPreferenceViewHolder.findViewById(2131821153)).setChecked(this.isChecked);
      Integer localInteger = new Integer(this.index);
      ImageView localImageView = (ImageView)paramPreferenceViewHolder.findViewById(2131821155);
      if (this.isSystem)
      {
      ...
      for (;;)
      {
        paramPreferenceViewHolder = paramPreferenceViewHolder.findViewById(2131821152);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/HomeSettings.class
