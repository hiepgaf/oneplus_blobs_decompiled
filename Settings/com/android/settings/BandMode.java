  ...
  extends Activity
{
  ...
  {
    String str = getString(2131625319) + " [" + this.mTargetBand.toString() + "] ";
    if (paramThrowable != null) {}
    for (paramThrowable = str + getString(2131625320);; paramThrowable = str + getString(2131625321))
    {
  ...
  {
    Object localObject = getString(2131625318);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    setTitle(getString(2131625317));
    getWindow().setLayout(-1, -2);
    this.mPhone = PhoneFactory.getDefaultPhone();
    this.mBandList = ((ListView)findViewById(2131820722));
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/android/settings/BandMode.class
