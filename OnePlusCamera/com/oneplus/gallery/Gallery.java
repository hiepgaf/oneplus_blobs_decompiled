  ...
  extends ComponentOwnerObject
{
  ...
  {
    if (paramMedia != null) {
      return deleteMedia(paramMediaSet, Arrays.asList(new Media[] { paramMedia }), paramMediaDeletionCallback);
    }
  ...
  {
    return deleteMedia(paramMediaSet, paramCollection, null);
  }
  
  public abstract boolean deleteMedia(MediaSet paramMediaSet, Collection<Media> paramCollection, MediaDeletionCallback paramMediaDeletionCallback);
  ...
  {
    verifyAccess();
    Handle local4 = new Handle("Gallery Dialog Handle")
    {
    ...
    this.m_GalleryDialogHandles.add(local4);
  ...
  public boolean startCamera(MediaType paramMediaType)
  {
    ...
    for (;;)
    {
      ...
      localObject = GalleryApplication.current();
      break;
      label83:
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/oneplus/gallery/Gallery.class
