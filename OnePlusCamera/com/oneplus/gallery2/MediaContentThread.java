...
public final class MediaContentThread
  extends BaseThread
{
    ...
    throws InterruptedException
  {
    synchronized (m_StartLock)
    {
      if (m_Current == null)
      {
        ...
        MediaContentThread localMediaContentThread = new MediaContentThread();
        localMediaContentThread.start();
        m_StartLock.wait();
        m_Current = localMediaContentThread;
        return;
      }
      return;
    }
    ...
    throws InterruptedException
  {
    ...
    //   1: ifnull +52 -> 53
    //   4: aload_0
    //   5: invokevirtual 62	com/oneplus/gallery2/MediaContentThread:isDependencyThread	()Z
    //   8: ifne +55 -> 63
    //   11: iconst_2
    ...
    //   17: monitorenter
    //   18: aload_0
    //   19: new 8	com/oneplus/gallery2/MediaContentThread$2
    //   22: dup
    //   23: aload_0
    //   24: aload_2
    //   25: aload_1
    //   26: invokespecial 65	com/oneplus/gallery2/MediaContentThread$2:<init>	(Lcom/oneplus/gallery2/MediaContentThread;[Ljava/lang/Object;Ljava/util/concurrent/Callable;)V
    ...
    //   0	109	0	this	MediaContentThread
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/oneplus/gallery2/MediaContentThread.class
