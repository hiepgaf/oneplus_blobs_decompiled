  ...
  extends ComponentOwnerActivity
{
  ...
  private int getCurrentBrightness()
  {
    ...
    //   5: iload_1
    //   6: istore_2
    //   7: new 306	java/io/BufferedReader
    //   10: dup
    //   11: new 308	java/io/FileReader
    //   14: dup
    //   15: ldc_w 310
    //   18: invokespecial 311	java/io/FileReader:<init>	(Ljava/lang/String;)V
    //   21: invokespecial 314	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   24: astore_3
    //   25: aload_3
    //   26: invokevirtual 317	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   29: astore 5
    //   31: aload 5
    //   33: ifnull +39 -> 72
    //   36: aload_0
    //   37: getfield 235	com/oneplus/gallery2/GalleryActivity:TAG	Ljava/lang/String;
    //   40: new 146	java/lang/StringBuilder
    //   43: dup
    //   44: ldc_w 319
    //   47: invokespecial 159	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   50: aload 5
    //   52: invokevirtual 165	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   55: invokevirtual 168	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   58: invokestatic 322	com/oneplus/base/Log:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   61: aload 5
    //   63: invokestatic 328	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   66: istore_2
    //   67: iload_2
    //   68: istore_1
    //   69: goto -44 -> 25
    ...
    //   79: istore_2
    //   80: aload_3
    //   81: invokevirtual 331	java/io/BufferedReader:close	()V
    //   84: iload_1
    //   85: ireturn
    //   86: astore_3
    //   87: iload_2
    ...
    //   103: astore_3
    //   104: aload_0
    //   105: getfield 235	com/oneplus/gallery2/GalleryActivity:TAG	Ljava/lang/String;
    //   108: ldc_w 333
    //   111: aload_3
    //   112: invokestatic 337	com/oneplus/base/Log:e	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    //   115: iload_1
    //   116: ireturn
    //   117: astore 4
    //   119: aload_3
    ...
    //   125: athrow
    //   126: aload_3
    //   127: invokevirtual 331	java/io/BufferedReader:close	()V
    //   130: goto -7 -> 123
    //   133: aload_3
    //   134: astore 4
    //   136: goto -36 -> 100
    //   139: aload 4
    //   141: aload_3
    //   142: invokevirtual 341	java/lang/Throwable:addSuppressed	(Ljava/lang/Throwable;)V
    //   145: goto -45 -> 100
    //   148: astore_3
    //   149: goto -60 -> 89
  ...
  public boolean dispatchTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      try
      {
        ...
        while (!((Boolean)this.m_ProcessingDialog.get(ProcessingDialog.PROP_IS_VISIBLE)).booleanValue())
        {
      ...
      return true;
    } while (!((Boolean)this.m_Gallery.get(Gallery.PROP_HAS_DIALOG)).booleanValue());
  ...
  protected final void onSaveInstanceState(Bundle paramBundle)
  {
    for (;;)
    {
      ...
      {
        Log.w(this.TAG, "onSaveInstanceState() - ex:", paramBundle);
        return;
      }
    }
  }
  ...
  {
    BaseActivity.State localState;
    if (paramIntent != null)
    {
      verifyAccess();
      localState = (BaseActivity.State)get(PROP_STATE);
    }
    switch ($SWITCH_TABLE$com$oneplus$base$BaseActivity$State()[localState.ordinal()])
    {
    default: 
      Log.w(this.TAG, "startActivityForResult() - Invalid activity state: " + localState);
      return null;
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/oneplus/gallery2/GalleryActivity.class
