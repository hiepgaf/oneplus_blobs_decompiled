  ...
  implements CameraPager
{
  ...
  {
    public int compare(VerticalViewPager.ItemInfo paramAnonymousItemInfo1, VerticalViewPager.ItemInfo paramAnonymousItemInfo2)
    {
  ...
  private final Runnable mEndScrollRunnable = new Runnable()
  {
    public void run()
    {
      VerticalViewPager.-wrap0(VerticalViewPager.this, 0);
  ...
  private ItemInfo infoForCurrentScrollPosition()
  {
    ...
    for (;;)
    {
      ...
      f3 = localItemInfo1.heightFactor;
      if ((j != 0) || (f1 >= f4))
      {
  ...
  private boolean isGutterDrag(float paramFloat1, float paramFloat2)
  {
    ...
    while ((paramFloat1 > getHeight() - this.mGutterSize) && (paramFloat2 < 0.0F)) {
      return true;
    }
    return false;
  }
  ...
  private void recomputeScrollPosition(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    {
      paramInt1 = (int)((paramInt1 - getPaddingTop() - getPaddingBottom()) * f);
  ...
  private void scrollToItem(int paramInt1, boolean paramBoolean1, int paramInt2, boolean paramBoolean2)
  {
    ...
    int i = 0;
    if (localItemInfo != null) {
      i = (int)(getClientHeight() * Math.max(this.mFirstOffset, Math.min(localItemInfo.offset, this.mLastOffset)));
    }
    if (paramBoolean1)
    {
  ...
  public boolean arrowScroll(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      Log.e(TAG, "arrowScroll tried to find focus based on non-child current focused view " + localStringBuilder.toString());
      localObject = null;
      break;
      label270:
  ...
  protected boolean canScroll(View paramView, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramBoolean) {
      return ViewCompat.canScrollVertically(paramView, -paramInt1);
    }
    return false;
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((i == 0) || ((i == 1) && (this.mAdapter != null) && (this.mAdapter.getCount() > 1)))
    {
      ...
      if (!this.mTopEdge.isFinished())
      {
        ...
        paramCanvas.translate(getPaddingLeft(), this.mFirstOffset * j);
        this.mTopEdge.setSize(k - m - n, j);
        bool1 = this.mTopEdge.draw(paramCanvas);
      ...
      if (!this.mBottomEdge.isFinished())
      {
        ...
        paramCanvas.translate(-k - getPaddingLeft(), -(this.mLastOffset + 1.0F) * j);
        this.mBottomEdge.setSize(k, j);
        bool2 = bool1 | this.mBottomEdge.draw(paramCanvas);
        paramCanvas.restoreToCount(i);
      }
    }
    for (;;)
  ...
  public void endFakeDrag()
  {
    ...
    setCurrentItemInternal(determineTargetPage(((ItemInfo)localObject).position, (k / j - ((ItemInfo)localObject).offset) / ((ItemInfo)localObject).heightFactor, i, (int)(this.mLastMotionY - this.mInitialMotionY)), true, true, i);
    endDrag();
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      label271:
      float f4;
      for (f1 = ((ItemInfo)localObject).offset + ((ItemInfo)localObject).heightFactor + f3;; f1 += f4 + f3)
      {
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i != -1)
      {
        ...
        if ((f1 == 0.0F) || (isGutterDrag(this.mLastMotionY, f1)))
        {
          label233:
        ...
        while ((this.mIsBeingDragged) && (performDrag(f2)))
        {
          ViewCompat.postInvalidateOnAnimation(this);
          break;
          if (!canScroll(this, false, (int)f1, (int)f3, (int)f2)) {
            break label233;
          }
          this.mLastMotionX = f3;
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramInt4 = i5 - paramInt1 - paramInt4;
    paramInt3 = 0;
    while (paramInt3 < i3)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (!localLayoutParams.isDecor)
        {
          ...
          if (localItemInfo != null)
          {
            j = paramInt1 + (int)(paramInt4 * localItemInfo.offset);
            if (localLayoutParams.needsMeasure)
            {
              localLayoutParams.needsMeasure = false;
              localView.measure(View.MeasureSpec.makeMeasureSpec(i4 - paramInt2 - i, 1073741824), View.MeasureSpec.makeMeasureSpec((int)(paramInt4 * localLayoutParams.heightFactor), 1073741824));
            }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      for (f1 = this.mInitialMotionY + this.mTouchSlop;; f1 = this.mInitialMotionY - this.mTouchSlop)
      {
        ...
        bool1 = performDrag(MotionEventCompat.getY(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, this.mActivePointerId)));
        break;
      }
      bool1 = bool2;
      if (this.mIsBeingDragged)
      {
        ...
        int k = getScrollY();
        localObject = infoForCurrentScrollPosition();
        setCurrentItemInternal(determineTargetPage(((ItemInfo)localObject).position, (k / j - ((ItemInfo)localObject).offset) / ((ItemInfo)localObject).heightFactor, i, (int)(MotionEventCompat.getY(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, this.mActivePointerId)) - this.mInitialMotionY)), true, true, i);
        this.mActivePointerId = -1;
        endDrag();
        bool1 = this.mTopEdge.onRelease() | this.mBottomEdge.onRelease();
        continue;
        bool1 = bool2;
        if (this.mIsBeingDragged)
        {
  ...
  void populate(int paramInt)
  {
    ...
    if (localObject3 != null)
    {
      ...
      if (n >= 0)
      {
        ...
        f3 = ((ItemInfo)localObject3).heightFactor;
        m = k + 1;
        if (f3 < 2.0F)
        {
          if (m >= this.mItems.size()) {
    ...
    for (localObject1 = ((ItemInfo)localObject3).object;; localObject1 = null)
    {
      ...
      while (paramInt < i)
      {
        ...
        if ((!((LayoutParams)localObject1).isDecor) && (((LayoutParams)localObject1).heightFactor == 0.0F))
        {
          localObject2 = infoForChild((View)localObject2);
          if (localObject2 != null)
          {
            ((LayoutParams)localObject1).heightFactor = ((ItemInfo)localObject2).heightFactor;
      ...
      localObject1 = null;
      break label378;
      f2 = 2.0F - ((ItemInfo)localObject3).heightFactor + getPaddingLeft() / i4;
      break label391;
      paramInt = k;
      float f1 = f3;
      localObject1 = localObject4;
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          {
            f1 = f3 + ((ItemInfo)localObject4).heightFactor;
            i = n - 1;
            if (i >= 0)
            {
              localObject1 = (ItemInfo)this.mItems.get(i);
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            paramInt = m + 1;
            f1 = f3 + ((ItemInfo)localObject1).heightFactor;
            if (paramInt < this.mItems.size()) {
              localObject1 = (ItemInfo)this.mItems.get(paramInt);
            } else {
              localObject1 = null;
  ...
  void setChildrenDrawingOrderEnabledCompat(boolean paramBoolean)
  {
    ...
    catch (NoSuchMethodException localNoSuchMethodException)
    {
      for (;;)
      {
        ...
        {
          Log.e(TAG, "Error changing children drawing order", localException);
        }
        localNoSuchMethodException = localNoSuchMethodException;
        Log.e(TAG, "Can't find setChildrenDrawingOrderEnabled", localNoSuchMethodException);
      }
    }
  }
  ...
  public void setOffscreenPageLimit(int paramInt)
  {
    ...
    if (paramInt < 1)
    {
      Log.w(TAG, "Requested offscreen page limit " + paramInt + " too small; defaulting to " + 1);
      i = 1;
    }
    ...
    extends ViewGroup.LayoutParams
  {
    ...
    public LayoutParams(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, VerticalViewPager.-get0());
    ...
    extends AccessibilityDelegateCompat
  {
    ...
    {
      return (VerticalViewPager.-get1(VerticalViewPager.this) != null) && (VerticalViewPager.-get1(VerticalViewPager.this).getCount() > 1);
    }
    ...
    public void onInitializeAccessibilityEvent(View paramView, AccessibilityEvent paramAccessibilityEvent)
    {
      ...
      if ((paramAccessibilityEvent.getEventType() == 4096) && (VerticalViewPager.-get1(VerticalViewPager.this) != null))
      {
        paramView.setItemCount(VerticalViewPager.-get1(VerticalViewPager.this).getCount());
        paramView.setFromIndex(VerticalViewPager.-get2(VerticalViewPager.this));
        paramView.setToIndex(VerticalViewPager.-get2(VerticalViewPager.this));
      }
    }
    ...
    public boolean performAccessibilityAction(View paramView, int paramInt, Bundle paramBundle)
    {
      ...
      case 4096: 
        if (VerticalViewPager.this.internalCanScrollVertically(1))
        {
          VerticalViewPager.this.setCurrentItem(VerticalViewPager.-get2(VerticalViewPager.this) + 1);
          return true;
        }
        return false;
      }
    ...
    extends View.BaseSavedState
  {
    ...
    {
      public VerticalViewPager.SavedState createFromParcel(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
      {
        return new VerticalViewPager.SavedState(paramAnonymousParcel, paramAnonymousClassLoader);
      }
      
      public VerticalViewPager.SavedState[] newArray(int paramAnonymousInt)
      {
        return new VerticalViewPager.SavedState[paramAnonymousInt];
      }
    });
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/oneplus/camera/ui/VerticalViewPager.class
