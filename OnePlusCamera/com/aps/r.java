  ...
  implements Closeable
{
  ...
  public r(InputStream paramInputStream, int paramInt, Charset paramCharset)
  {
  ...
  public r(InputStream paramInputStream, Charset paramCharset)
  {
            ...
            ByteArrayOutputStream local1 = new ByteArrayOutputStream(this.e - this.d + 80)
            {
              public String toString()
              {
                ...
                for (int i = this.count;; i = this.count - 1)
                {
                  try
                  {
                    String str = new String(this.buf, 0, i, r.a(r.this).name());
                    return str;
                  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/aps/r.class
