...
public abstract class DisplayManagerCompat
{
  ...
  public static DisplayManagerCompat getInstance(Context paramContext)
  {
    for (;;)
    {
      ...
      {
        localObject = (DisplayManagerCompat)sInstances.get(paramContext);
        if (localObject != null) {
      ...
      Object localObject = new JellybeanMr1Impl(paramContext);
    }
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/support/v4/hardware/display/DisplayManagerCompat.class
