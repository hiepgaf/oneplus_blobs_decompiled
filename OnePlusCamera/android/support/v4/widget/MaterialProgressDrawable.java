  ...
  implements Animatable
{
  ...
  private void setupAnimators()
  {
    ...
    Animation local1 = new Animation()
    {
      public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
      {
        ...
        {
          float f3 = (float)Math.toRadians(localRing.getStrokeWidth() / (localRing.getCenterRadius() * 6.283185307179586D));
          ...
          MaterialProgressDrawable.this.setRotation(144.0F * paramAnonymousFloat + f1 * 720.0F);
          return;
        }
  ...
  public boolean isRunning()
  {
    ...
    if (!localAnimation.hasStarted()) {}
    while (localAnimation.hasEnded())
    {
      i += 1;
      break;
    }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/support/v4/widget/MaterialProgressDrawable.class
