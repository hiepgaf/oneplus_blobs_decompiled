  ...
  implements View.OnTouchListener
{
  ...
  private boolean shouldAnimate()
  {
    ...
    if (i == 0) {}
    while (!canTargetScrollVertically(i))
    {
      if (j != 0) {
        break;
      }
    ...
    while (canTargetScrollHorizontally(j)) {
      return true;
    }
    return false;
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ...
      if (AutoScrollHelper.this.mAnimating)
      {
        ...
        localClampedScroller = AutoScrollHelper.this.mScroller;
        if (!localClampedScroller.isFinished()) {
          break label68;
        }
      }
      label46:
      label68:
      while (!AutoScrollHelper.this.shouldAnimate())
      {
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/support/v4/widget/AutoScrollHelper.class
