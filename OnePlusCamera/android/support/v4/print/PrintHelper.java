...
public final class PrintHelper
{
    ...
    implements PrintHelper.PrintHelperVersionImpl
  {
    ...
    public void printBitmap(String paramString, Bitmap paramBitmap, final PrintHelper.OnPrintFinishCallback paramOnPrintFinishCallback)
    {
      ...
      for (paramOnPrintFinishCallback = (PrintHelper.OnPrintFinishCallback)localObject;; paramOnPrintFinishCallback = new PrintHelperKitkat.OnPrintFinishCallback()
          {
      ...
      {
        this.mPrintHelper.printBitmap(paramString, paramBitmap, paramOnPrintFinishCallback);
        return;
      }
    }
      ...
      throws FileNotFoundException
    {
      ...
      {
        this.mPrintHelper.printBitmap(paramString, paramUri, paramOnPrintFinishCallback);
        return;
      }
    }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/support/v4/print/PrintHelper.class
