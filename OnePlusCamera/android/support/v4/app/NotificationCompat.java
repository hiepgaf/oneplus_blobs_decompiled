...
public class NotificationCompat
{
  ...
  private static Notification[] getNotificationArrayFromBundle(Bundle paramBundle, String paramString)
  {
    ...
    if ((arrayOfParcelable instanceof Notification[])) {}
    ...
    extends NotificationCompatBase.Action
  {
    ...
    private Action(int paramInt, CharSequence paramCharSequence, PendingIntent paramPendingIntent, Bundle paramBundle, RemoteInput[] paramArrayOfRemoteInput)
    {
      ...
      this.mExtras = paramCharSequence;
    ...
    public static final class Builder
    {
      ...
      {
        if (this.mRemoteInputs == null) {}
        for (RemoteInput[] arrayOfRemoteInput = null;; arrayOfRemoteInput = (RemoteInput[])this.mRemoteInputs.toArray(new RemoteInput[this.mRemoteInputs.size()])) {
    ...
    implements NotificationCompat.Extender
  {
    ...
    public CarExtender(Notification paramNotification)
    {
      ...
      label40:
      for (paramNotification = NotificationCompat.getExtras(paramNotification).getBundle("android.car.EXTENSIONS"); paramNotification == null; paramNotification = null)
      {
        return;
        return;
      }
    ...
    implements NotificationCompat.Extender
  {
    ...
    public WearableExtender(Notification paramNotification)
    {
      ...
      for (paramNotification = null; paramNotification == null; paramNotification = paramNotification.getBundle("android.wearable.EXTENSIONS")) {
        return;
      }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/support/v4/app/NotificationCompat.class
