  ...
  extends IInterface
{
    ...
    implements INotificationSideChannel
  {
    ...
    public static INotificationSideChannel asInterface(IBinder paramIBinder)
    {
      ...
      {
        localIInterface = paramIBinder.queryLocalInterface("android.support.v4.app.INotificationSideChannel");
        if (localIInterface != null) {
          break label28;
        }
      }
      label28:
      while (!(localIInterface instanceof INotificationSideChannel))
      {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        for (paramParcel1 = null;; paramParcel1 = (Notification)Notification.CREATOR.createFromParcel(paramParcel1))
        {
      ...
      implements INotificationSideChannel
    {
        ...
        throws RemoteException
      {
        ...
        //   41: aload_0
        //   42: getfield 19	android/support/v4/app/INotificationSideChannel$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   45: iconst_1
        //   46: aload 5
        //   48: aconst_null
        //   49: iconst_1
        ...
        //   62: aload 5
        //   64: iconst_1
        //   65: invokevirtual 45	android/os/Parcel:writeInt	(I)V
        //   68: aload 4
        //   70: aload 5
        //   72: iconst_0
        //   73: invokevirtual 66	android/app/Notification:writeToParcel	(Landroid/os/Parcel;I)V
        //   76: goto -35 -> 41
        //   79: astore_1
        //   80: aload 5
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/support/v4/app/INotificationSideChannel.class
