  ...
  implements TabHost.OnTabChangeListener
{
  ...
  private void ensureContent()
  {
    ...
    } while (this.mRealTabContent != null);
  ...
  protected void onAttachedToWindow()
  {
    ...
    else
    {
      ...
      do
      {
        ...
        break;
        localObject2 = localObject1;
      } while (localTabInfo.fragment.isDetached());
  ...
  {
    if (!this.mAttached) {}
    while (this.mOnTabChangeListener == null)
    {
      return;
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/support/v13/app/FragmentTabHost.class
