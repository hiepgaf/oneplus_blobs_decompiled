  ...
  implements ComponentBuilder
{
  public Component create(Object... paramVarArgs)
  {
    if ((paramVarArgs != null) && (paramVarArgs.length > 0) && ((paramVarArgs[0] instanceof BaseApplication))) {
      return new StorageManagerImpl((ComponentOwner)paramVarArgs[0], ((BaseApplication)paramVarArgs[0]).getApplicationContext());
    }
    return null;
  }
  ...
  {
    return StorageManager.class.isAssignableFrom(paramClass);
  }
}


/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/oneplus/io/StorageManagerBuilder.class
