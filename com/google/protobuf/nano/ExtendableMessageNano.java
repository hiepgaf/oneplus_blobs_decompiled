  ...
  extends MessageNano
{
  ...
  public final <T> T getExtension(Extension<M, T> paramExtension)
  {
    ...
    FieldData localFieldData = this.unknownFieldData.get(WireFormatNano.getTagFieldNumber(paramExtension.tag));
  ...
  public final boolean hasExtension(Extension<M, ?> paramExtension)
  {
    ...
    if (this.unknownFieldData.get(WireFormatNano.getTagFieldNumber(paramExtension.tag)) != null) {
      bool = true;
    }
    return bool;
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/com/google/protobuf/nano/ExtendableMessageNano.class
