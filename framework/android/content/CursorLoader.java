  ...
  extends AsyncTaskLoader<Cursor>
{
  ...
  public Cursor loadInBackground()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: invokevirtual 135	android/content/CursorLoader:isLoadInBackgroundCanceled	()Z
    //   6: ifeq +16 -> 22
    //   9: new 137	android/os/OperationCanceledException
    //   12: dup
    //   13: invokespecial 139	android/os/OperationCanceledException:<init>	()V
    //   16: athrow
    //   17: astore_1
    //   18: aload_0
    //   19: monitorexit
    ...
    //   21: athrow
    //   22: aload_0
    //   23: new 51	android/os/CancellationSignal
    //   26: dup
    //   27: invokespecial 140	android/os/CancellationSignal:<init>	()V
    //   30: putfield 49	android/content/CursorLoader:mCancellationSignal	Landroid/os/CancellationSignal;
    //   33: aload_0
    //   34: monitorexit
    //   35: aload_0
    //   36: invokevirtual 144	android/content/CursorLoader:getContext	()Landroid/content/Context;
    //   39: invokevirtual 150	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   42: aload_0
    //   43: getfield 35	android/content/CursorLoader:mUri	Landroid/net/Uri;
    //   46: aload_0
    //   47: getfield 37	android/content/CursorLoader:mProjection	[Ljava/lang/String;
    //   50: aload_0
    //   51: getfield 39	android/content/CursorLoader:mSelection	Ljava/lang/String;
    //   54: aload_0
    //   55: getfield 41	android/content/CursorLoader:mSelectionArgs	[Ljava/lang/String;
    //   58: aload_0
    //   59: getfield 43	android/content/CursorLoader:mSortOrder	Ljava/lang/String;
    //   62: aload_0
    //   63: getfield 49	android/content/CursorLoader:mCancellationSignal	Landroid/os/CancellationSignal;
    //   66: invokevirtual 156	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    //   69: astore_1
    //   70: aload_1
    //   71: ifnull +20 -> 91
    //   74: aload_1
    ...
    //   81: aload_1
    //   82: aload_0
    //   83: getfield 31	android/content/CursorLoader:mObserver	Landroid/content/Loader$ForceLoadContentObserver;
    //   86: invokeinterface 164 2 0
    //   91: aload_0
    //   92: monitorenter
    //   93: aload_0
    //   94: aconst_null
    //   95: putfield 49	android/content/CursorLoader:mCancellationSignal	Landroid/os/CancellationSignal;
    //   98: aload_0
    //   99: monitorexit
    //   100: aload_1
    //   101: areturn
    ...
    //   114: aload_0
    //   115: aconst_null
    //   116: putfield 49	android/content/CursorLoader:mCancellationSignal	Landroid/os/CancellationSignal;
    //   119: aload_0
    //   120: monitorexit
    //   121: aload_1
    //   122: athrow
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/content/CursorLoader.class
