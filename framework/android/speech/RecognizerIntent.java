...
public class RecognizerIntent
{
  ...
  {
    Object localObject = new Intent("android.speech.action.WEB_SEARCH");
    paramContext = paramContext.getPackageManager().resolveActivity((Intent)localObject, 128);
    if ((paramContext == null) || (paramContext.activityInfo == null)) {}
    while (paramContext.activityInfo.metaData == null) {
      return null;
    }
    localObject = paramContext.activityInfo.metaData.getString("android.speech.DETAILS");
    if (localObject == null) {
      return null;
    }
    Intent localIntent = new Intent("android.speech.action.GET_LANGUAGE_DETAILS");
    localIntent.setComponent(new ComponentName(paramContext.activityInfo.packageName, (String)localObject));
    return localIntent;
  }
}


/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/speech/RecognizerIntent.class
