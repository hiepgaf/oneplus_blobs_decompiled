  ...
  implements Parcelable
{
  ...
  public boolean doesClassMatch(int paramInt)
  {
    ...
    if (paramInt == 3) {
      return (getDeviceClass() & 0x500) == 1280;
    }
    if ((paramInt == 4) || (paramInt == 5))
    {
      ...
      return (getDeviceClass() & 0x300) == 768;
    }
    return false;
  }
  ...
  {
    boolean bool = false;
    if ((paramObject instanceof BluetoothClass))
    {
      if (this.mClass == ((BluetoothClass)paramObject).mClass) {
        bool = true;
      }
      return bool;
    }
  ...
  {
    return this.mClass & 0x1FFC;
  }
  
  public int getMajorDeviceClass()
  {
    return this.mClass & 0x1F00;
  }
  
  public boolean hasService(int paramInt)
  {
    boolean bool = false;
    if ((this.mClass & 0xFFE000 & paramInt) != 0) {
      bool = true;
    }
    return bool;
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/bluetooth/BluetoothClass.class
