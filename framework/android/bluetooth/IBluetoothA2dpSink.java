  ...
  extends IInterface
{
    ...
    implements IBluetoothA2dpSink
  {
      ...
      throws RemoteException
    {
      ...
      for (paramParcel1 = (BluetoothDevice)BluetoothDevice.CREATOR.createFromParcel(paramParcel1);; paramParcel1 = null)
      {
        bool = isA2dpPlaying(paramParcel1);
        paramParcel2.writeNoException();
        paramInt1 = m;
        if (bool) {
          paramInt1 = 1;
      ...
      implements IBluetoothA2dpSink
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 19	android/bluetooth/IBluetoothA2dpSink$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   34: iconst_5
        //   35: aload_3
        //   36: aload 4
        //   38: iconst_0
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/bluetooth/IBluetoothA2dpSink.class
