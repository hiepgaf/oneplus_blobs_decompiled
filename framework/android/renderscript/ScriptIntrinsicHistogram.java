  ...
  extends ScriptIntrinsic
{
  ...
  {
    if ((paramElement.isCompatible(Element.U8_4(paramRenderScript))) || (paramElement.isCompatible(Element.U8_3(paramRenderScript)))) {}
    while ((paramElement.isCompatible(Element.U8_2(paramRenderScript))) || (paramElement.isCompatible(Element.U8(paramRenderScript)))) {
  ...
  public void forEach(Allocation paramAllocation, Script.LaunchOptions paramLaunchOptions)
  {
    ...
    if ((paramAllocation.getType().getElement().isCompatible(Element.U8(this.mRS))) || (paramAllocation.getType().getElement().isCompatible(Element.U8_2(this.mRS)))) {}
    while ((paramAllocation.getType().getElement().isCompatible(Element.U8_3(this.mRS))) || (paramAllocation.getType().getElement().isCompatible(Element.U8_4(this.mRS))))
    {
  ...
  public void setDotCoefficients(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4)
  {
    ...
    while ((paramFloat3 < 0.0F) || (paramFloat4 < 0.0F)) {
  ...
  public void setOutput(Allocation paramAllocation)
  {
    ...
    if ((this.mOut.getType().getX() != 256) || (this.mOut.getType().getY() != 0)) {}
    while ((this.mOut.getType().hasMipmaps()) || (this.mOut.getType().getYuv() != 0)) {
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/renderscript/ScriptIntrinsicHistogram.class
