...
public class DatabaseUtils
{
  ...
  {
    String[] arrayOfString = paramCursor.getColumnNames();
    paramStringBuilder.append("").append(paramCursor.getPosition()).append(" {\n");
    int j = arrayOfString.length;
    int i = 0;
    for (;;)
    {
      if (i < j) {
        ...
        {
          String str1 = paramCursor.getString(i);
          paramStringBuilder.append("   ").append(arrayOfString[i]).append('=').append(str1).append("\n");
          i += 1;
        }
        catch (SQLiteException localSQLiteException)
        {
  ...
  {
    paramStringBuilder.append(">>>>> Dumping cursor ").append(paramCursor).append("\n");
    if (paramCursor != null)
    {
      int i = paramCursor.getPosition();
      paramCursor.moveToPosition(-1);
  ...
  public static class InsertHelper
  {
    ...
    private long insertInternal(ContentValues paramContentValues, boolean paramBoolean)
    {
      ...
      //   12: astore 5
      //   14: aload 5
      //   16: invokevirtual 151	android/database/sqlite/SQLiteStatement:clearBindings	()V
      //   19: aload_1
      ...
      //   65: invokevirtual 181	android/database/DatabaseUtils$InsertHelper:getColumnIndex	(Ljava/lang/String;)I
      //   68: aload 7
      //   70: invokeinterface 184 1 0
      //   75: invokestatic 188	android/database/DatabaseUtils:bindObjectToProgram	(Landroid/database/sqlite/SQLiteProgram;ILjava/lang/Object;)V
      //   78: goto -48 -> 30
      //   81: astore 5
      //   83: ldc -66
      ...
      //   106: aload_0
      //   107: getfield 42	android/database/DatabaseUtils$InsertHelper:mTableName	Ljava/lang/String;
      ...
      //   121: pop
      //   122: aload_0
      //   123: getfield 40	android/database/DatabaseUtils$InsertHelper:mDb	Landroid/database/sqlite/SQLiteDatabase;
      //   126: invokevirtual 206	android/database/sqlite/SQLiteDatabase:endTransaction	()V
      //   129: ldc2_w 207
      //   132: lreturn
      //   133: aload 5
      //   135: invokevirtual 212	android/database/sqlite/SQLiteStatement:executeInsert	()J
      //   138: lstore_3
      //   139: aload_0
      //   140: getfield 40	android/database/DatabaseUtils$InsertHelper:mDb	Landroid/database/sqlite/SQLiteDatabase;
      //   143: invokevirtual 215	android/database/sqlite/SQLiteDatabase:setTransactionSuccessful	()V
      //   146: aload_0
      //   147: getfield 40	android/database/DatabaseUtils$InsertHelper:mDb	Landroid/database/sqlite/SQLiteDatabase;
      //   150: invokevirtual 206	android/database/sqlite/SQLiteDatabase:endTransaction	()V
      //   153: lload_3
      //   154: lreturn
      //   155: astore_1
      //   156: aload_0
      //   157: getfield 40	android/database/DatabaseUtils$InsertHelper:mDb	Landroid/database/sqlite/SQLiteDatabase;
      //   160: invokevirtual 206	android/database/sqlite/SQLiteDatabase:endTransaction	()V
      //   163: aload_1
      //   164: athrow
      ...
      //   133	146	81	android/database/SQLException
      //   7	30	155	finally
      //   30	78	155	finally
      //   83	122	155	finally
      //   133	146	155	finally
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/database/DatabaseUtils.class
