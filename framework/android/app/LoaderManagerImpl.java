  ...
  extends LoaderManager
{
    ...
    implements Loader.OnLoadCompleteListener<Object>, Loader.OnLoadCanceledListener<Object>
  {
    ...
    void callOnLoadFinished(Loader<Object> paramLoader, Object paramObject)
    {
      ...
      {
        str = null;
        if (LoaderManagerImpl.-get0(LoaderManagerImpl.this) != null)
        {
          str = LoaderManagerImpl.-get0(LoaderManagerImpl.this).mFragmentManager.mNoTransactionsBecause;
          LoaderManagerImpl.-get0(LoaderManagerImpl.this).mFragmentManager.mNoTransactionsBecause = "onLoadFinished";
        }
      }
      try
      {
        ...
        if (LoaderManagerImpl.-get0(LoaderManagerImpl.this) != null) {
          LoaderManagerImpl.-get0(LoaderManagerImpl.this).mFragmentManager.mNoTransactionsBecause = str;
        }
    ...
    void destroy()
    {
      ...
      if ((this.mCallbacks != null) && (this.mLoader != null) && (this.mHaveData) && (bool))
      {
        ...
        {
          str = LoaderManagerImpl.-get0(LoaderManagerImpl.this).mFragmentManager.mNoTransactionsBecause;
          LoaderManagerImpl.-get0(LoaderManagerImpl.this).mFragmentManager.mNoTransactionsBecause = "onLoaderReset";
        }
      }
      try
      {
    ...
    public void onLoadComplete(Loader<Object> paramLoader, Object paramObject)
    {
      ...
      for (;;)
      {
        ...
        if ((LoaderManagerImpl.-get0(LoaderManagerImpl.this) != null) && (!LoaderManagerImpl.this.hasRunningLoaders())) {
          break;
        }
        return;
      ...
      LoaderManagerImpl.-get0(LoaderManagerImpl.this).mFragmentManager.startPendingDeferredFragments();
    }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/app/LoaderManagerImpl.class
