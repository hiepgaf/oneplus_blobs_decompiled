  ...
  implements DialogInterface.OnDismissListener, DialogInterface.OnCancelListener
{
  ...
  public Intent getAssistIntent(boolean paramBoolean)
  {
    try
    {
      ...
      if (paramBoolean)
      {
        Bundle localBundle = ActivityManagerNative.getDefault().getAssistContextExtras(0);
        if (localBundle != null) {
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/app/SearchManager.class
