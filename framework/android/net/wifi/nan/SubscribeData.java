...
{
  public static final Parcelable.Creator<SubscribeData> CREATOR = new Parcelable.Creator()
  {
    public SubscribeData createFromParcel(Parcel paramAnonymousParcel)
    {
      ...
      return new SubscribeData(str, arrayOfByte1, i, arrayOfByte2, j, arrayOfByte3, k, null);
    }
    
    public SubscribeData[] newArray(int paramAnonymousInt)
    {
      return new SubscribeData[paramAnonymousInt];
    }
  };
  ...
  private SubscribeData(String paramString, byte[] paramArrayOfByte1, int paramInt1, byte[] paramArrayOfByte2, int paramInt2, byte[] paramArrayOfByte3, int paramInt3)
  {
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (!(paramObject instanceof SubscribeData)) {
      return false;
    }
    if ((!this.mServiceName.equals(((SubscribeData)paramObject).mServiceName)) || (this.mServiceSpecificInfoLength != ((SubscribeData)paramObject).mServiceSpecificInfoLength)) {}
    while ((this.mTxFilterLength != ((SubscribeData)paramObject).mTxFilterLength) || (this.mRxFilterLength != ((SubscribeData)paramObject).mRxFilterLength)) {
      return false;
    }
    int i;
    if ((this.mServiceSpecificInfo != null) && (((SubscribeData)paramObject).mServiceSpecificInfo != null)) {
      i = 0;
    }
    ...
    if ((this.mTxFilter != null) && (((SubscribeData)paramObject).mTxFilter != null)) {
      i = 0;
    }
    ...
    if ((this.mRxFilter != null) && (((SubscribeData)paramObject).mRxFilter != null)) {
      i = 0;
    }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/net/wifi/nan/SubscribeData.class
