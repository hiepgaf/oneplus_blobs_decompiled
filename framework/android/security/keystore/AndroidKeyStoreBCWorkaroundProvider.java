  ...
  extends Provider
{
  ...
  {
    put("Cipher." + paramString1, paramString2);
    put("Cipher." + paramString1 + " SupportedKeyClasses", "android.security.keystore.AndroidKeyStorePrivateKey|android.security.keystore.AndroidKeyStorePublicKey");
  }
  
  private void putMacImpl(String paramString1, String paramString2)
  {
    put("Mac." + paramString1, paramString2);
    put("Mac." + paramString1 + " SupportedKeyClasses", "android.security.keystore.AndroidKeyStoreSecretKey");
  }
  
  private void putSignatureImpl(String paramString1, String paramString2)
  {
    put("Signature." + paramString1, paramString2);
    put("Signature." + paramString1 + " SupportedKeyClasses", "android.security.keystore.AndroidKeyStorePrivateKey|android.security.keystore.AndroidKeyStorePublicKey");
  }
  
  private void putSymmetricCipherImpl(String paramString1, String paramString2)
  {
    put("Cipher." + paramString1, paramString2);
    put("Cipher." + paramString1 + " SupportedKeyClasses", "android.security.keystore.AndroidKeyStoreSecretKey");
  }
}


/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/security/keystore/AndroidKeyStoreBCWorkaroundProvider.class
