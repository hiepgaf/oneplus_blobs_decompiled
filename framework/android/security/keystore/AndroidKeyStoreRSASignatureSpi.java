  ...
  extends AndroidKeyStoreSignatureSpiBase
{
    ...
    throws InvalidKeyException
  {
    if (!"RSA".equalsIgnoreCase(paramAndroidKeyStoreKey.getAlgorithm())) {
      throw new InvalidKeyException("Unsupported key algorithm: " + paramAndroidKeyStoreKey.getAlgorithm() + ". Only" + "RSA" + " supported");
    }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/security/keystore/AndroidKeyStoreRSASignatureSpi.class
