...
public abstract class CameraMetadata<TKey>
{
  ...
  static <TKey> ArrayList<TKey> getKeysStatic(Class<?> paramClass, Class<TKey> paramClass1, CameraMetadata<TKey> paramCameraMetadata, int[] paramArrayOfInt)
  {
    Object localObject1 = paramClass;
    if (paramClass.equals(TotalCaptureResult.class)) {
      localObject1 = CaptureResult.class;
    }
    if (paramArrayOfInt != null) {
      Arrays.sort(paramArrayOfInt);
    }
    ArrayList localArrayList = new ArrayList();
    paramClass = ((Class)localObject1).getDeclaredFields();
    int i = 0;
    int j = paramClass.length;
    while (i < j)
    {
      localObject1 = paramClass[i];
      if ((((Field)localObject1).getType().isAssignableFrom(paramClass1)) && ((((Field)localObject1).getModifiers() & 0x1) != 0)) {}
      try
      {
        Object localObject2 = ((Field)localObject1).get(paramCameraMetadata);
        if (((paramCameraMetadata == null) || (paramCameraMetadata.getProtected(localObject2) != null)) && (shouldKeyBeAdded(localObject2, (Field)localObject1, paramArrayOfInt))) {
    ...
    paramClass = CameraMetadataNative.getAllVendorKeys(paramClass1);
    if (paramClass != null)
    {
      ...
      while (paramClass1.hasNext())
      {
        ...
        for (;;)
        {
          if ((paramArrayOfInt != null) && (Arrays.binarySearch(paramArrayOfInt, CameraMetadataNative.getTag(paramClass)) < 0)) {
            break label263;
          }
  ...
  private static <TKey> boolean shouldKeyBeAdded(TKey paramTKey, Field paramField, int[] paramArrayOfInt)
  {
    ...
    while (paramField.getAnnotation(PublicKey.class) == null)
    {
      return false;
      if ((paramTKey instanceof CaptureResult.Key)) {
        paramTKey = ((CaptureResult.Key)paramTKey).getNativeKey();
      } else if ((paramTKey instanceof CaptureRequest.Key)) {
    ...
    return Arrays.binarySearch(paramArrayOfInt, paramTKey.getTag()) >= 0;
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/hardware/camera2/CameraMetadata.class
