...
public final class GeofenceHardware
{
  ...
  private GeofenceHardwareCallbackWrapper getCallbackWrapper(GeofenceHardwareCallback paramGeofenceHardwareCallback)
  {
    ...
    {
      GeofenceHardwareCallbackWrapper localGeofenceHardwareCallbackWrapper2 = (GeofenceHardwareCallbackWrapper)this.mCallbacks.get(paramGeofenceHardwareCallback);
      GeofenceHardwareCallbackWrapper localGeofenceHardwareCallbackWrapper1 = localGeofenceHardwareCallbackWrapper2;
      if (localGeofenceHardwareCallbackWrapper2 == null)
      {
        localGeofenceHardwareCallbackWrapper1 = new GeofenceHardwareCallbackWrapper(paramGeofenceHardwareCallback);
        this.mCallbacks.put(paramGeofenceHardwareCallback, localGeofenceHardwareCallbackWrapper1);
      }
      return localGeofenceHardwareCallbackWrapper1;
    }
  }
  ...
  private GeofenceHardwareMonitorCallbackWrapper getMonitorCallbackWrapper(GeofenceHardwareMonitorCallback paramGeofenceHardwareMonitorCallback)
  {
    ...
    {
      GeofenceHardwareMonitorCallbackWrapper localGeofenceHardwareMonitorCallbackWrapper2 = (GeofenceHardwareMonitorCallbackWrapper)this.mMonitorCallbacks.get(paramGeofenceHardwareMonitorCallback);
      GeofenceHardwareMonitorCallbackWrapper localGeofenceHardwareMonitorCallbackWrapper1 = localGeofenceHardwareMonitorCallbackWrapper2;
      if (localGeofenceHardwareMonitorCallbackWrapper2 == null)
      {
        localGeofenceHardwareMonitorCallbackWrapper1 = new GeofenceHardwareMonitorCallbackWrapper(paramGeofenceHardwareMonitorCallback);
        this.mMonitorCallbacks.put(paramGeofenceHardwareMonitorCallback, localGeofenceHardwareMonitorCallbackWrapper1);
      }
      return localGeofenceHardwareMonitorCallbackWrapper1;
    }
  }
  ...
  public boolean addGeofence(int paramInt1, int paramInt2, GeofenceHardwareRequest paramGeofenceHardwareRequest, GeofenceHardwareCallback paramGeofenceHardwareCallback)
  {
    try
    {
      if (paramGeofenceHardwareRequest.getType() == 0) {
        return this.mService.addCircularFence(paramInt2, new GeofenceHardwareRequestParcelable(paramInt1, paramGeofenceHardwareRequest), getCallbackWrapper(paramGeofenceHardwareCallback));
      }
  ...
  public int[] getMonitoringTypes()
  {
    try
    {
      int[] arrayOfInt = this.mService.getMonitoringTypes();
      return arrayOfInt;
    }
  ...
  public int getStatusOfMonitoringType(int paramInt)
  {
    try
    {
      paramInt = this.mService.getStatusOfMonitoringType(paramInt);
      return paramInt;
    }
    catch (RemoteException localRemoteException) {}
    return 2;
  ...
  public boolean pauseGeofence(int paramInt1, int paramInt2)
  {
    try
    {
      boolean bool = this.mService.pauseGeofence(paramInt1, paramInt2);
      return bool;
    }
    catch (RemoteException localRemoteException) {}
    return false;
  ...
  public boolean registerForMonitorStateChangeCallback(int paramInt, GeofenceHardwareMonitorCallback paramGeofenceHardwareMonitorCallback)
  {
    try
    {
      boolean bool = this.mService.registerForMonitorStateChangeCallback(paramInt, getMonitorCallbackWrapper(paramGeofenceHardwareMonitorCallback));
      return bool;
    }
  ...
  public boolean removeGeofence(int paramInt1, int paramInt2)
  {
    try
    {
      boolean bool = this.mService.removeGeofence(paramInt1, paramInt2);
      return bool;
    }
    catch (RemoteException localRemoteException) {}
    return false;
  ...
  public boolean resumeGeofence(int paramInt1, int paramInt2, int paramInt3)
  {
    try
    {
      boolean bool = this.mService.resumeGeofence(paramInt1, paramInt2, paramInt3);
      return bool;
    }
    catch (RemoteException localRemoteException) {}
    return false;
  ...
  public boolean unregisterForMonitorStateChangeCallback(int paramInt, GeofenceHardwareMonitorCallback paramGeofenceHardwareMonitorCallback)
  {
    ...
    try
    {
      boolean bool2 = this.mService.unregisterForMonitorStateChangeCallback(paramInt, getMonitorCallbackWrapper(paramGeofenceHardwareMonitorCallback));
      if (bool2)
      {
        bool1 = bool2;
    ...
    extends IGeofenceHardwareCallback.Stub
  {
    ...
    {
      GeofenceHardwareCallback localGeofenceHardwareCallback = (GeofenceHardwareCallback)this.mCallback.get();
    ...
    public void onGeofenceRemove(int paramInt1, int paramInt2)
    {
      ...
      if (localGeofenceHardwareCallback != null)
      {
        ...
        GeofenceHardware.-wrap0(GeofenceHardware.this, localGeofenceHardwareCallback);
      }
    }
    ...
    extends IGeofenceHardwareMonitorCallback.Stub
  {
    ...
    {
      boolean bool = false;
      GeofenceHardwareMonitorCallback localGeofenceHardwareMonitorCallback = (GeofenceHardwareMonitorCallback)this.mCallback.get();
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/hardware/location/GeofenceHardware.class
