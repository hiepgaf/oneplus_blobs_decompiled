  ...
  extends IInterface
{
    ...
    implements IGeofenceHardwareMonitorCallback
  {
      ...
      throws RemoteException
    {
      ...
      for (paramParcel1 = (GeofenceHardwareMonitorEvent)GeofenceHardwareMonitorEvent.CREATOR.createFromParcel(paramParcel1);; paramParcel1 = null)
      {
      ...
      implements IGeofenceHardwareMonitorCallback
    {
        ...
        throws RemoteException
      {
        ...
        //   20: aload_2
        //   21: iconst_0
        //   22: invokevirtual 50	android/hardware/location/GeofenceHardwareMonitorEvent:writeToParcel	(Landroid/os/Parcel;I)V
        //   25: aload_0
        //   26: getfield 19	android/hardware/location/IGeofenceHardwareMonitorCallback$Stub$Proxy:mRemote	Landroid/os/IBinder;
        //   29: iconst_1
        //   30: aload_2
        //   31: aconst_null
        //   32: iconst_1
        ...
        //   0	59	0	this	Proxy
        //   0	59	1	paramGeofenceHardwareMonitorEvent	GeofenceHardwareMonitorEvent
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/hardware/location/IGeofenceHardwareMonitorCallback.class
