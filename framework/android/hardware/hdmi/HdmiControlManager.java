...
public final class HdmiControlManager
{
  ...
  public HdmiControlManager(IHdmiControlService paramIHdmiControlService)
  {
    ...
    try
    {
      paramIHdmiControlService = this.mService.getSupportedTypes();
      this.mHasTvDevice = hasDeviceType(paramIHdmiControlService, 0);
      this.mHasPlaybackDevice = hasDeviceType(paramIHdmiControlService, 4);
      return;
    }
  ...
  public void addHotplugEventListener(HotplugEventListener paramHotplugEventListener)
  {
    ...
    this.mHotplugEventListeners.put(paramHotplugEventListener, localIHdmiHotplugEventListener);
    try
    {
      this.mService.addHotplugEventListener(localIHdmiHotplugEventListener);
      return;
    }
  ...
  public HdmiClient getClient(int paramInt)
  {
    ...
    case 0: 
      if (this.mHasTvDevice) {
        localObject1 = new HdmiTvClient(this.mService);
      }
      return (HdmiClient)localObject1;
    }
    localObject1 = localObject2;
    if (this.mHasPlaybackDevice) {
      localObject1 = new HdmiPlaybackClient(this.mService);
    }
    return (HdmiClient)localObject1;
  }
  ...
  public void removeHotplugEventListener(HotplugEventListener paramHotplugEventListener)
  {
    ...
    paramHotplugEventListener = (IHdmiHotplugEventListener)this.mHotplugEventListeners.remove(paramHotplugEventListener);
    ...
    try
    {
      this.mService.removeHotplugEventListener(paramHotplugEventListener);
      return;
    }
    catch (RemoteException paramHotplugEventListener)
    {
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/hardware/hdmi/HdmiControlManager.class
