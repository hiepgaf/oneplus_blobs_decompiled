  ...
  extends ChunkHandler
{
  ...
  private Chunk handleMPRE(Chunk paramChunk)
  {
    ...
    catch (RuntimeException paramChunk)
    {
      for (;;)
      {
        Log.w("ddm-heap", "Method profiling end failed: " + paramChunk.getMessage());
        int i = 1;
      }
    }
  ...
  private Chunk handleMPSEOrSPSE(Chunk paramChunk, String paramString)
  {
    ...
    {
      Log.w("ddm-heap", paramString + " prof stream end failed: " + paramChunk.getMessage());
    }
    return createFailChunk(1, paramChunk.getMessage());
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/ddm/DdmHandleProfiling.class
