  ...
  implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener, PreferenceManager.OnActivityDestroyListener
{
  ...
  public DialogPreference(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    this.mDialogTitle = paramContext.getString(0);
    if (this.mDialogTitle == null) {
      this.mDialogTitle = getTitle();
    }
    this.mDialogMessage = paramContext.getString(1);
    this.mDialogIcon = paramContext.getDrawable(2);
  ...
  protected void showDialog(Bundle paramBundle)
  {
    ...
    this.mBuilder = new AlertDialog.Builder((Context)localObject).setTitle(this.mDialogTitle).setIcon(this.mDialogIcon).setPositiveButton(this.mPositiveButtonText, this).setNegativeButton(this.mNegativeButtonText, this);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/preference/DialogPreference.class
