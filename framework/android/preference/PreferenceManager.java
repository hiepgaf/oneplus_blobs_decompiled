...
public class PreferenceManager
{
  ...
  void dispatchActivityDestroy()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 225	android/preference/PreferenceManager:mActivityDestroyListeners	Ljava/util/List;
    //   8: ifnull +15 -> 23
    //   11: new 87	java/util/ArrayList
    //   14: dup
    //   15: aload_0
    //   16: getfield 225	android/preference/PreferenceManager:mActivityDestroyListeners	Ljava/util/List;
    //   19: invokespecial 90	java/util/ArrayList:<init>	(Ljava/util/Collection;)V
    //   22: astore_3
    //   23: aload_0
    //   24: monitorexit
    //   25: aload_3
    ...
    //   50: checkcast 6	android/preference/PreferenceManager$OnActivityDestroyListener
    //   53: invokeinterface 230 1 0
    //   58: iload_1
    //   59: iconst_1
    //   60: iadd
    //   61: istore_1
    ...
    //   69: athrow
    //   70: aload_0
    //   71: invokespecial 232	android/preference/PreferenceManager:dismissAllScreens	()V
    //   74: return
  ...
  public SharedPreferences getSharedPreferences()
  {
    ...
    for (;;)
    {
      ...
      continue;
      localContext = this.mContext.createCredentialProtectedStorageContext();
    }
  }
  ...
  PreferenceScreen inflateFromIntent(Intent paramIntent, PreferenceScreen paramPreferenceScreen)
  {
    ...
    for (;;)
    {
      ...
      if (localObject2 != null)
      {
        ...
        {
          localObject2 = ((ActivityInfo)localObject1).packageName + ":" + ((ActivityInfo)localObject1).metaData.getInt("android.preference");
          paramIntent = paramPreferenceScreen;
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/preference/PreferenceManager.class
