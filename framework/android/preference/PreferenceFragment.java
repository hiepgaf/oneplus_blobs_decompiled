  ...
  implements PreferenceManager.OnPreferenceTreeClickListener
{
  ...
  private void bindPreferences()
  {
    ...
    if (localPreferenceScreen != null)
    {
      ...
      if (localView != null)
      {
        localView = localView.findViewById(16908310);
        if ((localView instanceof TextView))
        {
          localCharSequence = localPreferenceScreen.getTitle();
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    this.mLayoutResId = paramBundle.getResourceId(0, this.mLayoutResId);
    paramBundle.recycle();
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/preference/PreferenceFragment.class
