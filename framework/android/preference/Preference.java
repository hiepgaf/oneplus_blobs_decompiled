  ...
  implements Comparable<Preference>
{
  ...
  private String mKey;
  private int mLayoutResId = 17367205;
  ...
  public Preference(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = paramContext.getIndexCount() - 1;
    if (paramInt1 >= 0)
    {
      ...
      for (;;)
      {
        paramInt1 -= 1;
        break;
        this.mIconResId = paramContext.getResourceId(paramInt2, 0);
        continue;
        this.mKey = paramContext.getString(paramInt2);
        continue;
        this.mTitleRes = paramContext.getResourceId(paramInt2, 0);
        this.mTitle = paramContext.getString(paramInt2);
        continue;
        this.mSummary = paramContext.getString(paramInt2);
        continue;
        this.mOrder = paramContext.getInt(paramInt2, this.mOrder);
        continue;
        this.mFragment = paramContext.getString(paramInt2);
        continue;
        this.mLayoutResId = paramContext.getResourceId(paramInt2, this.mLayoutResId);
        continue;
        this.mWidgetLayoutResId = paramContext.getResourceId(paramInt2, this.mWidgetLayoutResId);
        continue;
        this.mEnabled = paramContext.getBoolean(paramInt2, true);
        continue;
        this.mSelectable = paramContext.getBoolean(paramInt2, true);
        continue;
        this.mPersistent = paramContext.getBoolean(paramInt2, this.mPersistent);
        continue;
        this.mDependencyKey = paramContext.getString(paramInt2);
        continue;
        this.mDefaultValue = onGetDefaultValue(paramContext, paramInt2);
        continue;
        this.mShouldDisableView = paramContext.getBoolean(paramInt2, this.mShouldDisableView);
      }
    }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/preference/Preference.class
