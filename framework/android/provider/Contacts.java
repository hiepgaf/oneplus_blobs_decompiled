...
public class Contacts
{
    ...
    public static final CharSequence getDisplayLabel(Context paramContext, int paramInt1, int paramInt2, CharSequence paramCharSequence)
    {
      ...
      do
      {
        do
        {
          return paramContext;
          if (paramInt2 != 0) {
            return paramContext.getResources().getTextArray(17235968)[(paramInt2 - 1)];
          }
          paramContext = str;
        } while (TextUtils.isEmpty(paramCharSequence));
        return paramCharSequence;
        if (paramInt2 != 0) {
          return paramContext.getResources().getTextArray(17235972)[(paramInt2 - 1)];
        }
        paramContext = str;
      } while (TextUtils.isEmpty(paramCharSequence));
      return paramCharSequence;
    ...
    implements BaseColumns, Contacts.OrganizationColumns
  {
    ...
    public static final CharSequence getDisplayLabel(Context paramContext, int paramInt, CharSequence paramCharSequence)
    {
      String str = "";
      if (paramInt != 0) {
        paramContext = paramContext.getResources().getTextArray(17235970)[(paramInt - 1)];
      }
      do
      {
        return paramContext;
    ...
    implements BaseColumns, Contacts.PeopleColumns, Contacts.PhonesColumns, Contacts.PresenceColumns
  {
    ...
    public static Bitmap loadContactPhoto(Context paramContext, Uri paramUri, int paramInt, BitmapFactory.Options paramOptions)
    {
      ...
      if (localInputStream != null) {
        paramUri = BitmapFactory.decodeStream(localInputStream, null, paramOptions);
      }
    ...
    {
      paramContentResolver = paramContentResolver.query(Contacts.Groups.CONTENT_URI, GROUPS_PROJECTION, "system_id='Contacts'", null, null);
      if (paramContentResolver != null) {}
      try
      {
    ...
    public static final CharSequence getDisplayLabel(Context paramContext, int paramInt, CharSequence paramCharSequence, CharSequence[] paramArrayOfCharSequence)
    {
      ...
      if (paramInt != 0) {
        if (paramArrayOfCharSequence != null) {
          paramContext = paramArrayOfCharSequence[(paramInt - 1)];
        }
      }
      do
      {
        return paramContext;
        paramArrayOfCharSequence = paramContext.getResources().getTextArray(17235971);
        break;
        paramContext = str;
      } while (TextUtils.isEmpty(paramCharSequence));
      return paramCharSequence;
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/provider/Contacts.class
