...
public final class ContactsContract
{
  ...
  {
    return paramLong >= 9223372034707292160L;
  }
    ...
    implements BaseColumns, ContactsContract.ContactsColumns, ContactsContract.ContactOptionsColumns, ContactsContract.ContactNameColumns, ContactsContract.ContactStatusColumns, ContactsContract.ContactCounts
  {
    ...
    public static boolean isEnterpriseContactId(long paramLong)
    {
      boolean bool2 = false;
      boolean bool1 = bool2;
      if (paramLong >= ENTERPRISE_CONTACT_ID_BASE)
      {
        bool1 = bool2;
      ...
      implements BaseColumns, ContactsContract.ContactsColumns, ContactsContract.ContactOptionsColumns, ContactsContract.ContactStatusColumns
    {
      ...
      public static final class Builder
      {
        ...
        public Uri build()
        {
          ...
          localBuilder.appendEncodedPath(String.valueOf(this.mContactId));
          localBuilder.appendPath("suggestions");
          if (this.mLimit != 0) {
            localBuilder.appendQueryParameter("limit", String.valueOf(this.mLimit));
          }
          int j = this.mValues.size();
          int i = 0;
          while (i < j)
          {
            localBuilder.appendQueryParameter("query", "name:" + (String)this.mValues.get(i));
            i += 1;
          }
  ...
  public static final class QuickContact
  {
    ...
    {
      if ((!(paramContext instanceof ContextWrapper)) || ((paramContext instanceof Activity))) {
        if (!(paramContext instanceof Activity)) {
          break label83;
        }
      }
      label83:
      for (int i = 0;; i = 268468224)
      {
    ...
    {
      float f = paramContext.getResources().getCompatibilityInfo().applicationScale;
      int[] arrayOfInt = new int[2];
      paramView.getLocationOnScreen(arrayOfInt);
      Rect localRect = new Rect();
      localRect.left = ((int)(arrayOfInt[0] * f + 0.5F));
      localRect.top = ((int)(arrayOfInt[1] * f + 0.5F));
      localRect.right = ((int)((arrayOfInt[0] + paramView.getWidth()) * f + 0.5F));
      localRect.bottom = ((int)((arrayOfInt[1] + paramView.getHeight()) * f + 0.5F));
    ...
    public static Intent rebuildManagedQuickContactsIntent(String paramString, long paramLong1, boolean paramBoolean, long paramLong2, Intent paramIntent)
    {
      ...
      label136:
      for (localUri = Uri.withAppendedPath(ContactsContract.Contacts.CONTENT_LOOKUP_URI, paramString);; localUri = ContactsContract.Contacts.getLookupUri(paramLong1, paramString))
      {
        ...
        if (localUri != null)
        {
          paramString = localUri;
          if (paramLong2 != 0L) {
            paramString = localUri.buildUpon().appendQueryParameter("directory", String.valueOf(paramLong2)).build();
          }
        }
        ...
        throws RemoteException
      {
        ...
        for (;;)
        {
          ...
          do
          {
            ...
            String[] arrayOfString = DATA_KEYS;
            int i = 0;
            ...
            ((Entity)localObject).addSubValue(ContactsContract.Data.CONTENT_URI, localContentValues);
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/provider/ContactsContract.class
