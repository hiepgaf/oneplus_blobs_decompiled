  ...
  extends IInterface
{
  ...
  public abstract void onSvStatusChanged(int paramInt, int[] paramArrayOfInt, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2, float[] paramArrayOfFloat3)
    throws RemoteException;
    ...
    implements IGnssStatusListener
  {
      ...
      throws RemoteException
    {
      ...
      case 4: 
        paramParcel1.enforceInterface("android.location.IGnssStatusListener");
        onSvStatusChanged(paramParcel1.readInt(), paramParcel1.createIntArray(), paramParcel1.createFloatArray(), paramParcel1.createFloatArray(), paramParcel1.createFloatArray());
        return true;
      }
      paramParcel1.enforceInterface("android.location.IGnssStatusListener");
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/location/IGnssStatusListener.class
