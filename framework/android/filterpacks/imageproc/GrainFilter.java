  ...
  extends Filter
{
  ...
  public void initProgram(FilterContext paramFilterContext, int paramInt)
  {
    ...
    this.mNoiseProgram = localShaderProgram;
    ...
    this.mGrainProgram = paramFilterContext;
  ...
  public void process(FilterContext paramFilterContext)
  {
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        this.mNoiseProgram.process(new Frame[0], localFrame2);
        this.mGrainProgram.process(new Frame[] { localFrame1, localFrame2 }, localFrame3);
        pushOutput("image", localFrame3);
        localFrame3.release();
        localFrame2.release();
        return;
      } while (localFrameFormat.getTarget() == this.mTarget);
    }
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/filterpacks/imageproc/GrainFilter.class
