...
public class HardwarePropertiesManager
{
  ...
  public CpuUsageInfo[] getCpuUsages()
  {
    try
    {
      CpuUsageInfo[] arrayOfCpuUsageInfo = this.mService.getCpuUsages(this.mContext.getOpPackageName());
  ...
  public float[] getDeviceTemperatures(int paramInt1, int paramInt2)
  {
    ...
    try
    {
      float[] arrayOfFloat = this.mService.getDeviceTemperatures(this.mContext.getOpPackageName(), paramInt1, paramInt2);
      return arrayOfFloat;
    }
    catch (RemoteException localRemoteException)
    {
  ...
  public float[] getFanSpeeds()
  {
    try
    {
      float[] arrayOfFloat = this.mService.getFanSpeeds(this.mContext.getOpPackageName());
      return arrayOfFloat;
    }
    catch (RemoteException localRemoteException)
    {
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/os/HardwarePropertiesManager.class
