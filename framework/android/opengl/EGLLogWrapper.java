  ...
  implements EGL11
{
  ...
  public EGLContext eglCreateContext(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, EGLContext paramEGLContext, int[] paramArrayOfInt)
  {
    ...
    paramEGLDisplay = this.mEgl10.eglCreateContext(paramEGLDisplay, paramEGLConfig, paramEGLContext, paramArrayOfInt);
  ...
  public EGLSurface eglCreatePbufferSurface(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, int[] paramArrayOfInt)
  {
    ...
    paramEGLDisplay = this.mEgl10.eglCreatePbufferSurface(paramEGLDisplay, paramEGLConfig, paramArrayOfInt);
    returns(paramEGLDisplay);
    checkError();
    return paramEGLDisplay;
  }
  ...
  public EGLSurface eglCreatePixmapSurface(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, Object paramObject, int[] paramArrayOfInt)
  {
    ...
    paramEGLDisplay = this.mEgl10.eglCreatePixmapSurface(paramEGLDisplay, paramEGLConfig, paramObject, paramArrayOfInt);
    returns(paramEGLDisplay);
    checkError();
    return paramEGLDisplay;
  }
  ...
  public EGLSurface eglCreateWindowSurface(EGLDisplay paramEGLDisplay, EGLConfig paramEGLConfig, Object paramObject, int[] paramArrayOfInt)
  {
    ...
    paramEGLDisplay = this.mEgl10.eglCreateWindowSurface(paramEGLDisplay, paramEGLConfig, paramObject, paramArrayOfInt);
    returns(paramEGLDisplay);
    checkError();
    return paramEGLDisplay;
  }
  ...
  public String eglQueryString(EGLDisplay paramEGLDisplay, int paramInt)
  {
    ...
    paramEGLDisplay = this.mEgl10.eglQueryString(paramEGLDisplay, paramInt);
    returns(paramEGLDisplay);
    checkError();
    return paramEGLDisplay;
  }
...
/* Location:              /Users/joshua/Desktop/system_framework/classes-dex2jar.jar!/android/opengl/EGLLogWrapper.class
